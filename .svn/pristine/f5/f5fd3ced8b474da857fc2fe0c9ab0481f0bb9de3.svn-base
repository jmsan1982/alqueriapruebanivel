<?php
    class escuelapascuaController {
        ...
        public function actionEscuelaPascuaForm() {
             ...
             /*   if (($mesnaz == $mes) && ($dianaz > $dia)) {
                ...
                */
                ...
                if ($anonaz >= 2009 && $anonaz <= 2015) {
                    ...
                    $todoslosregistros = escuela_pascua::comprobarRepetidos();
                    ...
                    $dir_subida         = 'img/sipescuelapascua/';
                    ...
                    $ultimopedido       = escuela_pascua::findLastNumeroPedidoEscuelaPascua();
                   // $numeropedido       = $ultimopedido['MAX(numeropedido)'];
                    ...
                    $numeropedido = $numeropedido . "epas21";
...
//error_log("ficherosubido2: ".$ficherosubido2);
                    ...
                    if ($enviar == "tarjeta") {
                        $tipopago           = "ONLINE";
                        $nuevoformulario    = escuela_pascua::newFormEscuelaPascua(
                        ...
                        if ($nuevoformulario) {
                            header('Location: https://servicios.alqueriadelbasket.com/tpv_escuelapascua/tpv.php?pedido=' . $numeropedido . '&titular=' . $nombreapellidos . '&importe=' . $importe);
                            //header('Location: http://localhost/serviciosalqueria3/tpv_escuelapascua/tpv.php?pedido=' . $numeropedido . '&titular=' . $nombreapellidos . '&importe=' . $importe);
                        }
                        else {
                            echo "<script text='javascript' charset='utf-8'>
                                    alert('Parece que hubo un error, inténtelo de nuevo más tarde.');
                                    window.location.replace('?r=index/EscuelaPascua2021');
                                </script>";
                            die;
                        }
                    }
                    elseif ($enviar == "oficina") {
                        //if ($ficherosubido2!="") {
                            ...
                            if ($nuevoformulario) {
                                ...
                                header('Location: https://servicios.alqueriadelbasket.com/?r=escuelapascua/okpagooficina&pedido=' . $numeropedido);
                                //header('Location: http://localhost/serviciosalqueria3/?r=escuelapascua/okpagooficina&pedido=' . $numeropedido);
                            }
                            else {
                ...
                // Si ha nacido fuera del rango de años permitido, mostramos mensaje de prohibición
                    ...
                    echo "<script text='javascript' charset='utf-8'>
                            alert('Lo sentimos pero el niño/a debe haber nacido entre 2009 y 2015 para participar en la escuela. ¡Gracias por contar con nosotros!');
                            window.location.replace('?r=index/EscuelaPascua2021');
                        </script>";
                    die;
                }
        ...
        public function actionOk() {
            ...
            $actualizaestado = escuela_pascua::actualizapagadoescuelapascuatpv($codigo, $pagado);
            ...
            $contenido =
                "<br><br><b>-Inscripcion en 5ª Escuela de Pascua 2021 nº: </b>".$contenidocorreo['numeropedido'].
            ...
            $enviodecorreo = escuela_pascua::mailssend($contenidocorreo['numeropedido'], $contenido, "Ficha inscripción 5ª Escuela Pascua 2021", $contenidocorreo['emailtutor']);
        ...
        public function actionokpagooficina() {
            ...
            $enviodecorreo = escuela_pascua::mailssend($contenidocorreo['numeropedido'], $contenido, "Ficha inscripción pago trasferencia 5º Escuela Pascua 2021", $contenidocorreo['emailtutor']);
        ...
        public function actionImprimirFicha() {
            ...
            if (isset($_SESSION['usuario']) && ($_SESSION['rolusuario'] == "admin" || $_SESSION['rolusuario'] == "superadmin")) {
                ...
                $seccioninscripcion = "Ficha inscripción 5ª Escuela Pascua 2021";
                ...
                $contenido ="<b>Estos son los datos recibidos relacionados con su inscripción. </b>".
                    "<br><br><b>-Inscripcion en Escuela de Pascua 2021 nº: </b>".$contenidocorreo['numeropedido'].
        ...
        public function actionMostrarModalEscuelaPascua()
        {
            ...
            if (!empty($idinscripcion)) {
                ...
                $datos = escuela_pascua::findDatosEscuelaFPascuaById($idinscripcion);
                $alerta_cuenta = "";
        ...
        public function actionUpdateInscripcionModalEscuelaPascua()
        {
//            error_log(__FILE__.__FUNCTION__.__LINE__);
//            error_log(print_r($_POST,1));
      ...
      //  $alergias = filter_input(INPUT_POST, 'alergias', FILTER_SANITIZE_STRING);
       ...
       // $transporte = filter_input(INPUT_POST, 'transporte', FILTER_SANITIZE_STRING);
        ...
        if (!empty($_FILES['sipnuevo']['tmp_name'])) {
            ...
            $sip = 'img/sipescuelapascua/' . strtolower(self::sanitize_nombre_para_columna_myslq($_POST['nombre'])) . "-" . strtolower(self::sanitize_nombre_para_columna_myslq($_POST['apellidos'])) . "-S-" . date("d-m-Y-H-i-s") . "." . $extension;
        ...
        if (!empty($_FILES['resguardonuevo']['tmp_name'])) {
            ...
            $numerodeelementos = count($array_fichero_y_extension);
            $extension = $array_fichero_y_extension[$numerodeelementos - 1];
            $resguardo = 'img/sipescuelapascua/' . strtolower(self::sanitize_nombre_para_columna_myslq($_POST['nombre'])) . "-" . strtolower(self::sanitize_nombre_para_columna_myslq($_POST['apellidos'])) . "-R-" . date("d-m-Y-H-i-s") . "." . $extension;
        ...
        if (isset($idinscripcion) && !empty($idinscripcion)) {
         ...
         //  error_log("inscripcion: " . $idinscripcion);
            $instancia = escuela_pascua::updatefichaescuelaPascua(
        ...
        private static function sanitize_nombre_para_columna_myslq($string)
        {
            ...
            if(preg_match($regex, $str))
            {
                ...
                error_log("El string: ".$string." ha generado un error  escuelapascuacontroller en sanitize_nombre_para_columna_myslq()");
                return false;
            }
        }
        ...
        /********************************************************
        *  BACK ESCUELA PASCUA 2021
        ********************************************************/
        
        public function actionBackEscuelaPascua()
        {
            ...
            if (isset($_SESSION['usuario'])) {
                ...
                $datos['inscripciones'] = escuela_pascua::findInscripcionesPascuaActivas();
                $datos['numerototalinscripciones'] = count($datos['inscripciones']);

                $datos['inscripciones_manyanas'] = escuela_pascua::findInscripcionesPascuaByOpcion("Mañanas");
                $datos['inscripciones_completo'] = escuela_pascua::findInscripcionesPascuaByOpcion("Dia completo");
                $datos['inscripciones_sueltos'] = escuela_pascua::findInscripcionesPascuaByOpcion("Dias sueltos");

                vistaSinvista(array('datos' => $datos), "layoutsback/layout_back_escuela_pascua");
        ...
        public function actionModificaPagadoEscuelaPascua()
        {
            if (isset($_POST['id'])) {
                ...
                $slider = escuela_pascua::ActualizaPagadoEscuelaPascua($id, $pagado);
            } else {
                require "error.php";
            }
         ...
         public function actionDardeBajaEscuelaPascua()
        {
            ...
            if (isset($_POST['id'])) {
                ...
                echo "<div style='width:100%;height:100%;background-color: rgba(0,0,0,.8);padding-top:10%;'>
                            <div class='contact-form-wrapper' style='width:50%;margin-left:25%;background-color:white;border:1px solid #000000;border-radius: 10px 10px 10px 10px;padding:25px;'>
                                <form action='?r=escuelapascua/DardeBajaEscuelaPascua' method='post'>
            ...
            if (isset($_POST['confirm'])) {
                ...
                if ($_POST['confirm'] == "SI") {
                    ...
                    $baja_reg = escuela_pascua::DardeBajaEscuelaPascua($pedido);
                }
                if ($_POST['confirm'] == "NO") {
                    echo "<script text='javascript'> window.location.replace('?r=escuelapascua/BackEscuelaPascua'); </script>";
                }
            } else {
                require "error.php";
            }
        ...
        public function actionExportToExcelEscuelaPascua()
        {
           ...
           // error_log("aobserv: " . $_POST["alergias"]);
            ...
            $datos['inscripciones'] = escuela_pascua::findAllInscripcionesExcelEscuelaPascuaConCampos($where, $campoorder, $campos);

            if (isset($_POST["export_data"])) {
                $filename = "escuela_pascua_alqueria_" . date('Ymd') . ".xls";
        ...
        public function actionExportToExcelEscuelaPascuaCompleto()
        {

            require "models/escuela_pascua.php";

            $datos['inscripciones'] = escuela_pascua::findAllInscripcionesExcelEscuelaPascua();
