							...
							<div class="row">
								<div class="col-12 text-center">
									<h2 class="section-title mt-0 mb-0" style="color: #406da4;">
										<i class="fa fa-cloud" aria-hidden="true" style="margin-right: 10px;"></i><b>CAMPUS MURO DE LOS SUEÑOS</b>
									</h2>
								...
								<div class="col-12">
									...
									<form action="?r=campusmuro/ExportToExcelCampusMuro" method="post">
									...
									<form action="?r=campusmuro/ExportToExcelCampusMuroCompleto" method="post">
								...
								<div class="col-12 text-left">
									...
									<p>
										<br>
										<b>Nº de inscritos:  <?php echo $datos['numerototalinscripciones']; ?> (Mañanas: <?php echo $datos['inscripciones_manyanas'][0]; ?> , Completo: <?php echo $datos['inscripciones_completo'][0]; ?> )</b>
										<br>
									</p>
								</div>
											...
											<?php
												foreach ($datos['inscripciones'] as $inscripcion) {
													...
													echo '<tr id="' . $inscripcion['id'] . '">
															...
															<td class="text-left">' . $inscripcion['opcion']. '</td> 
															<td class="text-center">
																<a href="https://servicios.alqueriadelbasket.com/'.$inscripcion['fotocopiasip'].'" target="_blank">';
																	if ($extension == "pdf") {
															...
															<td class="text-center">';
                                                            	...
                                                            	{
                                                               		 echo '<a href="https://servicios.alqueriadelbasket.com/'.$inscripcion['resguardopago'].'" target="_blank">';
															...
															<td class="text-center">
																<form method="post" action="?r=campusmuro/ModificaPagadoCampusMuro">';
															...
															<td class="text-center">
																...
																<a href="?r=campusmuro/ImprimirFicha&numeropedido='.$inscripcion['numeropedido'].'&tipopago='.$inscripcion['tipo_pago'].'" target="_blank">
															...
															<td class="text-center">
																<form method="post" action="?r=campusmuro/DardeBajaCampusMuro">';
						...
						<div class="container-fluid">
							...
							<!-- <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 t-left" style="font-size: 1.2em;">
                                    <label class="containerchekbox">
                                        <input type="checkbox" name="dia6" value="dia6" id="dia6">
                                        <span class="checkmark"></span>Día 6
                                    </label>
                                </div>

                                <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-1" id="capa3" style="font-size: 14px; "> 
                                    <label class="radio-inline pr-1">
                                        <input type="radio" name="rdia6" value="dia6-manyana" > Mañana
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="rdia6" value="dia6-completo"> Completo
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 t-left" style="font-size: 1.2em;">
                                    <label class="containerchekbox">
                                        <input type="checkbox" name="dia7" value="dia7" id="dia7">
                                        <span class="checkmark"></span> Día 7
                                    </label>
                                </div>

                                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 mb-1" id="capa4" style="font-size: 14px; "> 
                                    <label class="radio-inline pr-1">
                                        <input type="radio" name="rdia7" value="dia7-manyana" > Mañana
                                    </label>
                                    <label class="radio-inline">
                                       <input type="radio" name="rdia7" value="dia7-completo"> Completo
                                   </label>
                               </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 t-left" style="font-size: 1.2em;">
                                    <label class="containerchekbox">
                                         <input type="checkbox" name="dia8" value="dia8" id="dia8">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 mb-1" id="capa5" style="font-size: 14px; ">
                                    <label class="radio-inline pr-1">
                                        <input type="radio" name="rdia8" value="dia8-manyana" > Mañana
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="rdia8" value="dia8-completo"> Completo
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 t-left" style="font-size: 1.2em;">
                                    <label class="containerchekbox">
                                         <input type="checkbox" name="dia9" value="dia9" id="dia9">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 mb-1" id="capa5" style="font-size: 14px; ">
                                    <label class="radio-inline pr-1">
                                        <input type="radio" name="rdia9" value="dia9-manyana" > Mañana
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="rdia9" value="dia9-completo"> Completo
                                    </label>
                                </div>
                            </div> -->
		...
		<script>
			$('document').ready(function () {
                ...
                $('body').on('click','.cargar_modal_editar_inscripcion',function()
                {
                    ...
                    $.ajax({
                        type:       "POST",
                        url:        "?r=campusmuro/MostrarModalCampusMuro",
                        data:       form_data,
                        dataType:   "json",
                        success:    function(data)
                        {
                            if(data.response==="success")
                            {
                              ...
                              /*  $("#dia6").prop('checked', false);
								...
								$("#dia8").prop('checked', false);
								$("#dia9").prop('checked', false);
								$("input[name=rdia6][value='dia6-manyana']").prop("checked",false);
								$("input[name=rdia7][value='dia7-manyana']").prop("checked",false);
								$("input[name=rdia8][value='dia8-manyana']").prop("checked",false);
								$("input[name=rdia9][value='dia9-manyana']").prop("checked",false);
								$("input[name=rdia6][value='dia6-completo']").prop("checked",false);
								$("input[name=rdia7][value='dia7-completo']").prop("checked",false);
								$("input[name=rdia8][value='dia8-completo']").prop("checked",false);
								$("input[name=rdia9][value='dia9-completo']").prop("checked",false);
								*/


								//recogemos los dias sueltos
							/*	if (data.instancia['turno1']=="-"){
                                   
                                    $("#dia6").prop('checked', false);
                                    $("input[name=rdia6][value='dia6-manyana']").prop("checked",false);
                                    $("input[name=rdia6][value='dia6-completo']").prop("checked",false);
                                }else if (data.instancia['turno1']=="Día 6 Mañana"){
                                	$("#dia6").prop('checked', true);
                                    $("input[name=rdia6][value='dia6-manyana']").prop("checked",true);
                                    
                                }else if (data.instancia['turno1']=="Día 6 Completo"){
                                	$("#dia6").prop('checked', true);
                                    $("input[name=rdia6][value='dia6-completo']").prop("checked",true);
                                }

                                if (data.instancia['turno2']=="-"){
                                   
                                    $("#dia7").prop('checked', false);
                                    $("input[name=rdia7][value='dia7-manyana']").prop("checked",false);
                                    $("input[name=rdia7][value='dia7-completo']").prop("checked",false);
                                }else if (data.instancia['turno2']=="Día 7 Mañana"){
                                	$("#dia7").prop('checked', true);
                                    $("input[name=rdia7][value='dia7-manyana']").prop("checked",true);
                                    
                                }else if (data.instancia['turno2']=="Día 7 Completo"){
                                	$("#dia7").prop('checked', true);
                                    $("input[name=rdia7][value='dia7-completo']").prop("checked",true);
                                }

                                if (data.instancia['turno3']=="-"){
                                   
                                    $("#dia8").prop('checked', false);
                                    $("input[name=rdia8][value='dia8-manyana']").prop("checked",false);
                                    $("input[name=rdia8][value='dia8-completo']").prop("checked",false);
                                }else if (data.instancia['turno3']=="Día 8 Mañana"){
                                	$("#dia8").prop('checked', true);
                                    $("input[name=rdia8][value='dia8-manyana']").prop("checked",true);
                                    
                                }else if (data.instancia['turno3']=="Día 8 Completo"){
                                	$("#dia8").prop('checked', true);
                                    $("input[name=rdia8][value='dia8-completo']").prop("checked",true);
                                }

                                if (data.instancia['turno4']=="-"){
                                   
                                    $("#dia9").prop('checked', false);
                                    $("input[name=rdia9][value='dia9-manyana']").prop("checked",false);
                                    $("input[name=rdia9][value='dia9-completo']").prop("checked",false);
                                }else if (data.instancia['turno4']=="Día 9 Mañana"){
                                	$("#dia9").prop('checked', true);
                                    $("input[name=rdia9][value='dia9-manyana']").prop("checked",true);
                                    
                                }else if (data.instancia['turno4']=="Día 9 Completo"){
                                	$("#dia9").prop('checked', true);
                                    $("input[name=rdia9][value='dia9-completo']").prop("checked",true);
                                }
                                */
                ...
                $("#form_editar_inscripciones").validate(
				{
					...
					submitHandler: function(form)
					{
				        ...
				        //console.log($('#genero-editar-inscripciones').val());
				      ...
				      // 	formData.append("transporte", 		$('#transporte-editar-inscripciones').val()); 
				       ...
				       // formData.append("operaciones", 		$('#operaciones-editar-inscripciones').val()); 
				        ...
				        console.log($("#dia6").prop('checked') + " -" +$("input[name='rdia6']:checked").val());

				        formData.append("dia1", 			$("#dia6").prop('checked')); 
				        formData.append("tipod1",			$("input[name='rdia6']:checked").val()); 

				        console.log($("#dia7").prop('checked')+ " -" +$("input[name='rdia7']:checked").val());
				        formData.append("dia2", 			$('#dia7').prop('checked'));
				        formData.append("tipod2",          $("input[name='rdia7']:checked").val()); 

				        console.log($("#dia8").prop('checked')+ " -" +$("input[name='rdia8']:checked").val());
                        formData.append("dia3",           $('#dia8').prop('checked'));
                        formData.append("tipod3",         $("input[name='rdia8']:checked").val());  

                        console.log($("#dia9").prop('checked')+ " -" +$("input[name='rdia9']:checked").val());
                        formData.append("dia4",           $('#dia9').prop('checked'));
                        formData.append("tipod4",         $("input[name='rdia9']:checked").val());  
                        */
				       

						$.ajax({
                            type:           "POST",
                            url:            "?r=campusmuro/UpdateInscripcionModalCampusMuro",
                            data:           formData,
