            ...
            <section id="page-content" class="overflow-x-hidden">
                ...
                <div class="block background-f6 min95">
                    <div class="container">
                        ...
                        <div  class="row">
                            ...
                            <div class="col-12 t-center">
                                <h2 class="section-title mb-0">
                                    Encuesta sobre <span class="orange-text">la jornada de Formación de L’Alqueria del Basket</span>
                                </h2>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <h4 class="section-title t-center">
                                    ¡Gracias por dedicarnos tu tiempo! Nos gustaría conocer tu opinión sobre la jornada de Formación.
                                </h4>
                        ...
                        <!-- Encuesta -->
                        <div class="row">
                            <form id="encuesta-jugadores-2020-form" class="boxed-form" method="post">
                                <div class="col-12">
                                    ...
                                    <p><strong>Valora del 1 al 5 tu nivel de satisfación:&nbsp; 1-Nada satisfecho  &nbsp;&nbsp;    2-Poco satisfecho &nbsp;&nbsp; 3-Neutral &nbsp;&nbsp; 4-Muy satisfecho &nbsp;&nbsp;  5-Totalmente satisfecho</strong></p>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-md-2 t-left">
                                                            ...
                                                            <div class="col-12 col-md-2 t-left">
                                                                <label class="control control--radio" style="font-size:15px;">
                                                                    <?php echo $array_opciones[3];?>
                                                                    <input type="radio" name="<?php echo $pregunta["id"]; ?>-pregunta-triple-radio" value="<?php echo $array_opciones[3];?>">
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="col-12 col-md-2 t-left">
                                                                <label class="control control--radio" style="font-size:15px;">
                                                                    <?php echo $array_opciones[4];?>
                                                                    <input type="radio" name="<?php echo $pregunta["id"]; ?>-pregunta-triple-radio" value="<?php echo $array_opciones[4];?>">
                                                                    <div class="control__indicator"></div>
                                                                </label>
                                                            </div>
                                    ...
                                    ?>
                                            ...
                                            <div class="row col-12">
                                                <div class="col-12 col-md-6">
                                                    <label><b><?php echo $pregunta["pregunta"].' -' .  $pregunta["id"];?></b></label>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="input-group">  
                                                            ...
                                                            <ul id="ul-<?php echo $pregunta["id"]; ?>-id-numero" class="rating linea_encuesta mt-0 mb-0 pl-0">
                                                                <!-- <li name="pregunta-<?php //echo $pregunta["id"]; ?>-valor-0" class="star">&star;</li> -->
                                                                <li name= "" id="pregunta-<?php echo $pregunta["id"]; ?>-valor-1" class="star">&star;</li>
                                                                <li name= "" id="pregunta-<?php echo $pregunta["id"]; ?>-valor-2" class="star">&star;</li>
                                                                <li name= "" id="pregunta-<?php echo $pregunta["id"]; ?>-valor-3" class="star">&star;</li>
                                                                <li name= "" id="pregunta-<?php echo $pregunta["id"]; ?>-valor-4" class="star">&star;</li>
                                                                <li name= "" id="pregunta-<?php echo $pregunta["id"]; ?>-valor-5" class="star">&star;</li>
                                    ...
                                    <div class="row mt-1">     
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            <input  id="id-encuesta"        name="id_encuesta"      type="hidden" value="16">
                                            <button id="btn-enviar-btn"     class="btn btn-link-w"  type="submit">
                                                <span>ENVIAR</span>
                                            </button>
                                        </div>
                                        
                                        <div id="encuesta-jugadores-2020-form-respuesta" class="col-12 mb-2"></div>
...
// }
            ...
            $("#buscar-email-usuario-jugadores-2020").on("click",function()
            {
                if( $("#email-form").val().trim() !== "" )
                {
                    $("#buscar-email-usuario-jugadores-2020-respuesta").html("");
                    $("#buscar-email-usuario-jugadores-2020-respuesta").hide();
                    ...
                    $.ajax({
                        ...
                        success:    function (data) 
                        {
                            ...
                            {
                                $("#buscar-email-usuario-jugadores-2020-respuesta").show();
                                $("#buscar-email-usuario-jugadores-2020-respuesta").html("<div class='alert alert-danger'>"+data.message+"</div>");
                            }
                        }
                    });
                }
                else
                {   $("#buscar-email-usuario-jugadores-2020-respuesta").html("<div class='alert alert-danger'>Parece que el email es incorrecto.</div>");  }
            });
            ...
            $('#encuesta-jugadores-2020-form').validate(
            {
                ...
                {   
                    ...
                    var data = $('#encuesta-jugadores-2020-form').serialize()+"&multiselect="+multiselect;
                   ...
                   // alert('Datos serializados: '+data);
                    ...
                    $.ajax({
                        ...
                        beforeSend: function()
                        {
                            $("#encuesta-jugadores-2020-form-respuesta").html("<div class='col 12 alert alert-info mb-0'>\n\
                        ...
                        success:    function(data)
                        {
                            if(data.response==="success")
                            {
                                $("#encuesta-jugadores-2020-form-respuesta").html("<div class='alert alert-success'>"+data.message+"</div>");
                                $("#encuesta-jugadores-2020-form-respuesta").fadeTo(10000, 500).slideUp(500,function(){
                                    $("#encuesta-jugadores-2020-form-respuesta").slideUp(500);
                                    $("#encuesta-jugadores-2020-form-respuesta").html("");
                                });
                            }
                            else if(data.response==="error")
                            {
                                $('#encuesta-jugadores-2020-form-respuesta').html("<div class='alert alert-danger'>" + data.message + "</div>");
                                $("#encuesta-jugadores-2020-form-respuesta").fadeTo(4000, 500).slideUp(500,function(){
                                    $("#encuesta-jugadores-2020-form-respuesta").slideUp(500);
                                    $("#encuesta-jugadores-2020-form-respuesta").html("");
                                });
                            }
