                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-12">
                                ...
                                <h4 class="section-title t-center">
                                    ¡Gracias por dedicarnos tu tiempo! Tras completarla, recibirás un código que representa un “15%” de descuento en la Tienda Oficial de Valencia Basket.
                                </h4>
                                
                                <p class="t-center">Aunque estamos en un año de continua adaptación, desde Valencia Basket queremos seguir construyendo nuestro futuro. Y, este, no será posible sin ti. Por ello, solicitamos tu participación en la siguiente encuesta. Es totalmente anónima y confidencial. 
