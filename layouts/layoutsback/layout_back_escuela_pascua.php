							...
							<div class="row">
								<div class="col-12 text-center">
									<h2 class="section-title mt-0 mb-0" style="color: #406da4;">
										<i class="fa fa-leaf" aria-hidden="true" style="margin-right: 10px;"></i><b>ESCUELA PASCUA</b>
									</h2>
								...
								<div class="col-12">
									...
									<form action="?r=escuelapascua/ExportToExcelEscuelaPascua" method="post">
									...
									<form action="?r=escuelapascua/ExportToExcelEscuelaPascuaCompleto" method="post">
											...
											<?php
												foreach ($datos['inscripciones'] as $inscripcion) {
													...
													echo '<tr id="' . $inscripcion['id'] . '">
															...
															<td class="text-center">
																<form method="post" action="?r=escuelaPascua/ModificaPagadoEscuelaPascua">';
															...
															<td class="text-center">
																...
																<a href="?r=escuelapascua/ImprimirFicha&numeropedido='.$inscripcion['numeropedido'].'&tipopago='.$inscripcion['tipo_pago'].'" target="_blank">
															...
															<td class="text-center">
																<form method="post" action="?r=escuelapascua/DardeBajaEscuelaPascua">';
		...
		<script>
			$('document').ready(function () {
                ...
                $('body').on('click','.cargar_modal_editar_inscripcion',function()
                {
                    ...
                    $.ajax({
                        type:       "POST",
                        url:        "?r=escuelaPascua/MostrarModalEscuelaPascua",
                        data:       form_data,
                        dataType:   "json",
					...
					submitHandler: function(form)
					{
				      ...
				      // 	formData.append("transporte", 		$('#transporte-editar-inscripciones').val()); 
				       ...
				       // formData.append("operaciones", 		$('#operaciones-editar-inscripciones').val()); 
						...
						$.ajax({
                            type:           "POST",
                            url:            "?r=escuelapascua/UpdateInscripcionModalEscuelaPascua",
                            data:           formData,
