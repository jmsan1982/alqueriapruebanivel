                                ...
                                <div class="col-12 col-md-9 col-lg-9 col-xl-9" id="titulo">                                
                                    <h2 class="section-title">
                                        <?php echo $lang["ins_cantera_renovacion"];?>  <span class="orange-text">
                                            <?php echo $lang["ins_cantera_escuela"];?></span>
                                    </h2>
                                    <h3 class="section-title mb-2"><?php echo $lang["ins_cantera_ficha"];?></h3>
                                </div>
                            </div>
...
<!--                                                    <div class="form-group col-12 col-md-2 col-lg-2 col-xl-2"> 
                            ...
                            <div class="row renovacion-row">
                                ...
                                <!-- Tabla informatica precios 1/2 -->
                                <div class="form-group col-12 mt-2">
                                    <table class="table table-striped form-group" border="1" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th scope="col" style="width: 20%; padding-top: 4px; padding-bottom: 4px;" colspan="6">BABY - PREBENJAMIN</th>    
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td id="lunes-form-masculino" style="text-align:center;padding-top: 4px;padding-bottom: 4px;" ><?php echo $lang["ins_cantera_escuela_incrip"];?></td>
                                                ...
                                                <td id="jueves-form-masculino" style="text-align:center;padding-top: 4px;padding-bottom: 4px;" >1-15 de <?php echo $lang["enero"];?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td id="martes-form-masculino" style="text-align:center;padding-top: 4px;padding-bottom: 4px;">150€* <br><strong> <?php echo $lang["ins_escuela_info_cuadro_pagos_dto"];?></strong></td>
                                ...
                                <!-- Tabla informatica precios 2/2 -->
                                <div class="form-group col-12 mt-2">
                                    <table class="table table-striped form-group" border="1" style="width: 100%;">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th scope="col" style="width: 20%;padding-top: 4px;padding-bottom: 4px;" colspan="6"><?php echo $lang["ins_escuela_info_cuadro_pagos"];?></th>    
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <td id="lunes-form-masculino" style="text-align:center;padding-top: 4px;padding-bottom: 4px;" >50€</td>
                                                <td id="martes-form-masculino" style="text-align:center;padding-top: 4px;padding-bottom: 4px;" >175* <br><strong> <?php echo $lang["ins_escuela_info_cuadro_pagos_dto"];?></strong></td>
                            ...
                            <div id="submit-container" class="row renovacion-row" style="display:none;">
                                <div class="form-group col-12 col-md-12 col-lg-12 col-xl-12">    
                                    <label><?php echo $lang["ins_escuela_metodo_pago_0"];?>
                                        <select class="form-control campos-required" id="metodo-pago-form" onChange="mostrarrecibo(this.value);" required>
                                            <option value=""><?php echo $lang["ins_controller_seleccionar"];?></option>     
                                            <option value="tarjeta"><?php echo $lang["ins_escuela_metodo_pago_2"];?></option>
                                            <option value="transferencia"><?php echo $lang["ins_escuela_metodo_pago_4"];?></option>
                                            <option value="recepcion"><?php echo $lang["ins_escuela_metodo_pago_1"];?></option>
                                        </select>
                                    </label>                                          
                                </div>
...
<!--        <script src="js/jquery.validate.min.js"></script>-->
        ...
        <script type="text/javascript">
            ...
            $("#buscar-jugador-dni-jugador").on( "click", function()
            {
                ...
                {
                    var form_data = {debug:"true",  jugadores_dni_jugador: $("#dni-jugador").val().trim(),  formulario:"ESCUELA"};
                    
                    $.ajax({
                        type:       "POST",
                        url:        "?r=jugadores/Cargar",
                        data:       form_data,
                        dataType:   "json",
            ...
            {            
                ...
                {
                    var form_data = {debug:"true",jugadores_dni_padremadre: $("#validacion-dni-padremadre").val().trim(),formulario:"ESCUELA"};
                    $.ajax({
                        type:       "POST",
                    ...
                    $("#paso-2-dni-tutor-selector-jugador").hide();
...
//alert("Ahora haríamos la llamada AJAX. Pero está comentada ");   
                    ...
                    {
                        type:           "POST",
                        url:            "?r=inscripciones/InscripcionEscuela2020",
                        data:           formData,
