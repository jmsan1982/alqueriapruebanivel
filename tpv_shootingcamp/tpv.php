...
$url="http://localhost/serviciosalqueria3/tpv_shootingcamp/ejemploRecepcionaPet.php";
$urlOK="http://localhost/serviciosalqueria3/tpv_shootingcamp/ejemploRecepcionaPet.php";
$urlKO="http://localhost/serviciosalqueria3/tpv_shootingcamp/ejemploRecepcionaPet.php";

//entorno real
/*
$url="https://servicios.alqueriadelbasket.com/tpv_shootingcamp/ejemploRecepcionaPet.php";
$urlOK="https://servicios.alqueriadelbasket.com/tpv_shootingcamp/ejemploRecepcionaPet.php";
$urlKO="https://servicios.alqueriadelbasket.com/tpv_shootingcamp/ejemploRecepcionaPet.php";
*/
...
//valores fijos
$concepto = 'Shooting Camp 2021';   //maximo 125 caracteres
//$amount=5000;//importe a pagar. Las dos ultimas posiciones se consideran decimales

$amount = $_GET['importe'];
//$amount=$amount."00";   //Las dos ultimas posiciones se consideran decimales, aqui no los ponemos porque viene con los ceros del formulario, porque hay un precio que lleva decimales.
