<!-- Start Page-Footer -->
<footer class="no-gutters t-white overflow-x-hidden overflow-y-hidden">
    <div class="row content-wrap-footer ml-0 mr-0">				
        <div class="b-inner3 col-12 col-sm-5 col-md-5 col-lg-4 col-xl-5">
            <ul style="padding-left: 0;">
                <li>
                    <a href="?r=index/Principal">
        ...
        <div class="b-inner3 hidden-xs col-md-2 col-lg-2 col-xl-2 logopie pt-0 t-center">
            <img src="../img/logo.png" class="img-fluid">
        </div>
        
        <div class="b-inner3 col-12 col-sm-7 col-md-7 col-lg-6 col-xl-5">
            <ul class="pull-right pr-3">
                <li>&copy; L´Alqueria del Basket <?php echo date("Y");?></li>
                <li>
                    <a href="http://tessq.com/" target="_blank" class="mr-1">Diseño Web por Tess Quality</a>
                </li>
            </ul>
        </div>					
    </div>
...
<div class="popup" data-popup="popup-1">
    <div class="popup-inner1">
        ...
        <p>Denominación Social: Valencia Basket Club S.A.D.</p>
        <p>Nombre Comercial: Valencia Basket Clubpolitica</p>
        <p>Domicilio Social: Av/ Hermanos Maristas 16, 46013, Valencia</p>
        <p>CIF / NIF: A46406930</p>
        <p>Teléfono: 963957084</p>
        <p>Fax: 963956801</p>
        <p>e-Mail: valencia.basket@valenciabasket.com</p>
        <p>Inscrita en el Registro: Registro Mercantil de Valencia</p>
        <p>Nombre de dominio: www.valenciabasket.com</p>
        ...
        <p>2.	Realizar estudios estadísticos.</p>
        <p>3.	Tramitar encargos, solicitudes o cualquier tipo de petición que sea realizada por el usuario a través de cualquiera de las formas de contacto que se ponen a disposición del usuario en el sitio web de la compañía.</p>
        <p>4.	Remitir el boletín de noticias de la página web.</p>
        ...
        <br>
        <h4 class="modal-title">USO DE COOKIES Y DEL FICHERO DE ACTIVIDAD</h4>
        ...
        <p>Mediante el uso de las cookies resulta posible que el servidor donde se encuentra la web, reconozca el navegador web utilizado por el usuario con la finalidad de que la navegación sea más </p>
        <p>sencilla, permitiendo, por ejemplo, el acceso a los usuarios que se hayan registrado previamente, acceder a las áreas, servicios, promociones o concursos reservados exclusivamente a ellos sin tener que registrarse en cada visita. Se utilizan también para medir la audiencia y parámetros del tráfico, controlar el progreso y número de entradas.</p>
        ...
        <br>
        <h4 class="modal-title">DIRECCIONES IP</h4>
...
<div class="popup" data-popup="popup-2">
    <div class="popup-inner2">
        <h2>Copyright</h2>
        <p>L'Alqueria del Basket se reserva el derecho el uso del contenido editorial de esta página web, para tener acceso a imágenes y dossiers es necesario regfistrarse e identificarse cómo usuario registrado.</p>
        <h4>PROPIEDAD INTELECTUAL E INDUSTRIAL</h4>
        <p>L'Alqueria del Basket por sí o como cesionaria, es titular de todos los derechos de propiedad intelectual e industrial desu página web, así como de los elementos contenidos en la misma (a título enunciativo, imágenes, sonido, audio, vídeo, software o textos; marcas o logotipos, combinaciones de colores, estructura y diseño, selección de materiales usados, programas de ordenador necesarios para su funcionamiento, acceso y uso, etc.), titularidad de L'Alqueria del Basket o bien de sus licenciantes.</p>
        ...
        <p>Podrá visualizar los elementos del portal e incluso imprimirlos, copiarlos y almacenarlos en el disco duro de su ordenador o en cualquier otro soporte físico siempre y cuando sea, única y exclusivamente, para su uso personal y privado. El USUARIO deberá abstenerse de suprimir, alterar, eludir o manipular cualquier dispositivo de protección o sistema de seguridad que estuviera instalado en el las páginas de L'Alqueria del Basket.</p>
...
<div class="popup" data-popup="popup-3">
    <div class="popup-inner3">
        ...
        <p>En cumplimiento con el deber de información recogido en artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico, a continuación se reflejan los siguientes datos: la empresa titular de dominio web es L'Alqueria del Basket (en adelante L'Alqueria del Basket), con domicilio a estos efectos en DDDDD número de C.I.F.: CCCCC inscrita en el MMMMM. Correo electrónico de contacto: EEEEE del sitio web.</p>
        <h4>USUARIOS</h4>
        <p>El acceso y/o uso de este portal de L'Alqueria del Basket atribuye la condición de USUARIO, que acepta, desde dicho acceso y/o uso, las Condiciones Generales de Uso aquí reflejadas. Las citadas Condiciones serán de aplicación independientemente de las Condiciones Generales de Contratación que en su caso resulten de obligado cumplimiento.</p>
        <h4>USO DEL PORTAL</h4>
        <p>L'Alqueria del Basket proporciona el acceso a multitud de informaciones, servicios, programas o datos (en adelante, “los contenidos”) en Internet pertenecientes a L'Alqueria del Basket o a sus licenciantes a los que el USUARIO pueda tener acceso. El USUARIO asume la responsabilidad del uso del portal. Dicha responsabilidad se extiende al registro que fuese necesario para acceder a determinados servicios o contenidos.</p>
        <p>En dicho registro el USUARIO será responsable de aportar información veraz y lícita. Como consecuencia de este registro, al USUARIO se le puede proporcionar una contraseña de la que será responsable, comprometiéndose a hacer un uso diligente y confidencial de la misma. El USUARIO se compromete a hacer un uso adecuado de los contenidos y servicios (como por ejemplo servicios de chat, foros de discusión o grupos de noticias) que Nombre de la empresa creadora del sitio web ofrece a través de su portal y con carácter enunciativo pero no limitativo, a no emplearlos para (i) incurrir en actividades ilícitas, ilegales o contrarias a la buena fe y al orden público; (ii) difundir contenidos o propaganda de carácter racista, xenófobo, pornográfico-ilegal, de apología del terrorismo o atentatorio contra los derechos humanos; (iii) provocar daños en los sistemas físicos y lógicos de Nombre de la empresa creadora del sitio web , de sus proveedores o de terceras personas, introducir o difundir en la red virus informáticos o cualesquiera otros sistemas físicos o lógicos que sean susceptibles de provocar los daños anteriormente mencionados; (iv) intentar acceder y, en su caso, utilizar las cuentas de correo electrónico de otros usuarios y modificaro manipular sus mensajes. Nombre de la empresa creadora del sitio web se reserva el derecho de retirar todos aquellos comentarios y aportaciones que vulneren el respeto a la dignidad de la persona, que sean discriminatorios, xenófobos, racistas, pornográficos, que atenten contra la juventud o la infancia, el orden o la seguridad pública o que, a su juicio, no resultaran adecuados para su publicación. En cualquier caso, L'Alqueria del Basket no será responsable de las opiniones vertidas por los usuarios a través de los foros, chats, u otras herramientas de participación.</p>
        <h4>PROTECCIÓN DE DATOS</h4>
        <p>L'Alqueria del Basket cumple con las directrices de la Ley Orgánica 15/1999 de 13 de diciembre de Protección de Datos de Carácter Personal, el Real Decreto 1720/2007 de 21 de diciembre por el que se aprueba el Reglamento de desarrollo de la Ley Orgánica y demás normativa vigente en cada momento, y vela por garantizar un correcto uso y tratamiento de los datos personales del usuario. Para ello, junto a cada formulario de recabo de datos de carácter personal, en los servicios que el usuario pueda solicitar a L'Alqueria del Basket, hará saber al usuario de la existencia y aceptación de las condiciones particulares del tratamiento de sus datos en cada caso, informándole de la responsabilidad del fichero creado, la dirección del responsable, la posibilidad de ejercer sus derechos de acceso, rectificación, cancelación u oposición, la finalidad del tratamiento y las comunicaciones de datos a terceros en su caso.</p>
        <p>Asimismo, L'Alqueria del Basket informa que da cumplimiento a la Ley 34/2002 de 11 de julio, de Servicios de la Sociedad de la Información y el Comercio Electrónico y le solicitará su consentimiento al tratamiento de su correo electrónico con fines comerciales en cada momento.</p>
        <h4>EXCLUSIÓN DE GARANTÍAS Y RESPONSABILIDAD</h4>
        <p>L'Alqueria del Basket no se hace responsable, en ningún caso, de los daños y perjuicios de cualquier naturaleza que pudieran ocasionar, a título enunciativo: errores u omisiones en los contenidos, falta de disponibilidad del portal o la transmisión de virus o programas maliciosos o lesivos en los contenidos, a pesar de haber adoptado todas las medidas tecnológicas necesarias para evitarlo.</p>
        <h4>MODIFICACIONES</h4>
        <p>L'Alqueria del Basket se reserva el derecho de efectuar sin previo aviso las modificaciones que considere oportunas en su portal, pudiendocambiar, suprimir o añadir tanto los contenidos y servicios que se presten a través de la misma como la forma en la que éstos aparezcan presentados o localizados en su portal.</p>
        <h4>ENLACES</h4>
        <p>En el caso de que en L'Alqueria del Basket se dispusiesen enlaces o hipervínculos hacía otros sitios de Internet, L'Alqueria del Basket no ejercerá ningún tipo de control sobre dichos sitios y contenidos. En ningún caso</p>
        <p>L'Alqueria del Basket asumirá responsabilidad alguna por los contenidos de algún enlace perteneciente a un sitio web ajeno, ni garantizará la disponibilidad técnica, calidad, fiabilidad, exactitud, amplitud, veracidad, validez y</p>
        <p>constitucionalidad de cualquier material o información contenida en ninguno de dichos hipervínculos u otros sitios de Internet.</p>
        ...
        <p>L'Alqueria del Basket se reserva el derecho a denegar o retirar el acceso a portal y/o los servicios ofrecidos sin necesidad de preaviso, a instancia propia o de un tercero, a aquellos usuarios que incumplan las presentes Condiciones Generales de Uso.</p>
        <h4>GENERALIDADES</h4>
        <p>L'Alqueria del Basket perseguirá el incumplimiento de las presentes condiciones así como cualquier utilización indebida de su portal ejerciendo todas las acciones civiles y penales que le puedan corresponder en derecho.</p>
        <h4>MODIFICACIÓN DE LAS PRESENTES CONDICIONES Y DURACIÓN</h4>
        <p>L'Alqueria del Basket podrá modificar en cualquier momento las condiciones aquí determinadas, siendo debidamente publicadas como aquí aparecen.</p>
        ...
        <p>La relación entre L'Alqueria del Basket y el USUARIO se regirá por la normativa española vigente y cualquier controversia se someterá a los Juzgados y tribunales de la ciudad de Valencia.</p>
        <a data-popup-close="popup-3" href="#">
            <button style="border-radius: 5px; background-color: #eb7c00; padding: 10px 20px; float: right;">CERRAR</button>
        </a>
