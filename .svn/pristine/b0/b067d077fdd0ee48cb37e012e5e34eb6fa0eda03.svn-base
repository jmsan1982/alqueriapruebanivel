                        ...
                        <div class="row mb-2">
                            <div class="col-12 t-center">
                                <h2 class="section-title mb-0">
                                    Encuesta <span class="orange-text">Padres</span>
                                </h2>
                            </div>
                            ...
                            <div class="col-12">
                                <p>A continuación, encontrará una serie de preguntas destinadas a conocer su opinión sobre diversos aspectos del L’Alqueria del Basket. Mediante ellas queremos conocer lo que piensan padres y familiares de jugadores sobre nosotros.</p>
                                <p>El tiempo de realización de la misma <u>no supera los 5 minutos</u>. Por favor, lea detenidamente cada pregunta y conteste la alternativa que más se acerca a lo que piensa. Esta encuesta es <u>anónima</u>, pero si lo desea, puede dejarnos su nombre completo y correo electrónico para, una vez finalizada, entrar en el <u><strong>sorteo de 2 entradas para un partido del Valencia Basket</strong></u>. Muchas gracias.</p>
                            </div>
                        </div>

                        <!-- Encuesta -->
                        <div class="row">
                            <form id="encuesta-padres-form" class="boxed-form" method="post">
                                <div class="form-group col-12">
                                    <div class="row">

                                        <div class="col-12">
                                            <h4 class="mt-0 mb-1">
                                                Nombre completo (<strong>opcional</strong>):
                                            </h4>
                                        </div>
                                        ...
                                        <?php
                                        foreach ($datos["padres"] as $pregunta ) 
                                        {
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            <button class="btn btn-link-w" type="submit" id="btn-enviar-padres">
                                                <span>ENVIAR</span>
                                            </button>
                                        </div>
                                    </div>
