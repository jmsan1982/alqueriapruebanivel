								...
								<div class="col-12 col-md-12">
									<div class="text-wrap">
										<h2 class="section-title">
											<span class="orange-text"><?php echo $lang["ins_escuela_tpv_ko_1"];?></span>
										</h2>
									</div>
								</div>

                                <div class="col-12 col-md-9 alqueria-bg-box mt-0">
                                    <p class='t-left'><?php echo $lang["ins_escuela_tpv_ko_2"];?><br>
                                        <?php echo $lang["ins_escuela_tpv_ko_3"];?></p>

                                    <p class='t-left'><b><?php echo $datos['Ds_Response_texto'];?></b></p>
                                    
									<a class="btn btn-link-o" href="" style="width:100%;"> <!--  href="?r=inscripciones/Escuela" -->
										<span style="margin-top: 15px;"><?php echo $lang["ins_escuela_tpv_ko_4"];?></span>
									</a>
								</div>
