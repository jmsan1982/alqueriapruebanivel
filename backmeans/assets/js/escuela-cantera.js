...
function mimodaldepagos(idinscripcion) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            // PARTE 1. La información de MATRICULAS SOLO ES VISIBLE A JUGADORES DE ESCUELA
            ...
            }   //  No se incluye porque ya está pagado
...
$('document').ready(function () {
    ...
    //  Cambio de checkbox de pago completo de matrícula
    ...
    $('#incluir-pendiente-matricula-en-xml').on('change', function () {
        if ($("#pagos-pendiente-matricula").val() == 0 && $('#pagos-pagado-pendiente-matricula').is(':checked')) {
            alert("La matrícula ya está pagada. No se puede incluir en la generación del XML.");
            document.getElementById("incluir-pendiente-matricula-en-xml").checked = false;
        } else {
        }
    });
    ...
    $('#solicitudeslicencia1920-listado-datatable').DataTable({
        ...
        language: {
            ...
            "lengthMenu": "Mostrando _MENU_ solicitudes de licencia por página",
    ...
    $('#inscripciones-escuelaycantera-listado-datatable').DataTable({
        ...
        language: {
            "search": "",
            "searchPlaceholder": "Buscar inscripción",
            "lengthMenu": "Mostrando _MENU_ inscripciones por página",
            "zeroRecords": "No hemos encontrado inscripciones",
            "bPaginate": false
        }
    ...
    $('#editar-cuenta-form').validate(
        {
            ...
            messages: {
                ...
                "entidad": {
                    ...
                    number: "El campo 'ENTIDAD' tiene que contener solo números.",
                ...
                "oficina": {
                    ...
                    number: "El campo 'OFICINA' tiene que contener solo números.",
                    minlength: "La longitud del campo debe de ser de 4 digitos. Ej:1234.",
                    maxlength: "La longitud del campo debe de ser de 4 digitos. Ej:1234."
                },
                "dc": {
                ...
                "cuenta": {
                    ...
                    number: "El campo 'CUENTA' tiene que contener solo números.",
    ...
    /*  pagos-trimestrales-form. Al marcar un trimestre para que se genere el cargo en el XML se comprueba que el pago no está ya hecho */
    $('#generar-xml-noviembre').on('click', function () {
        if (document.getElementById("pagos-pagado-noviembre").checked) {
            alert("No puede incluirse un trimestre que ya está pagado. Para incluirlo, anule el pago del trimestre antes.");
            document.getElementById("generar-xml-noviembre").checked = false;
        }
    });
    ...
    //  Operación del Modal: pagos-trimestrales-form. Formulario que gestiona el pago de los trimestres
    ...
    $('#domiciliaciones-xml-2019-2020-trimestre2-form').validate(
        {
            submitHandler: function () {
                /*  Como hay 2 botones submit, debemos saber el ID del botón y lanzar la llamada correspondiente:
    ...
    /* Domiciliaciones Trimestrales Inscripciones. Generación de XML. */
