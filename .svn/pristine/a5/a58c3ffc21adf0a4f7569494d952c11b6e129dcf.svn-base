...
<html lang="es"> 
    ...
    <body class="Pages">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 t-left">
                                <h2 class="section-title">
                                    Encuesta <span class="orange-text">Campus Pascua 2019</span>
                                </h2>
                            </div>
                        </div>

                        <div class="row">
                            <form id="encuesta-campus-pascua-2019-form" class="boxed-form" method="post">
                                <input id="id_encuesta"     type="hidden" name="id_encuesta" value="13">
                                    ...
                                    <div class="row"> 
                                        <div class="col-12 col-lg-6 t-left">
                                            <h4 class="t-left mt-0 mb-0">
                                                1. ¿Cómo valoras la experiencia del Campus de Pascua?
                                            </h4>
                                        </div>   
        ...
        <script type="text/javascript">
            $('#encuesta-campus-pascua-2019-form').validate({
                submitHandler:function(){
                    // Recogemos los valores del formulario
                        var form_data = {
                            form_id: "encuesta_campus_pascua_2019_participacion_nueva",
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                if(data.response==="success"){
                                    ...
                                    $('#encuesta-campus-pascua-2019-form-respuesta').html("<div class='alert alert-success w-100' style='padding:1.5em 1em;width:100%;font-size:1.3em;'>" + data.message + "</div>");
                                    $("#encuesta-campus-pascua-2019-form-respuesta").fadeTo(4000, 500).slideUp(500,function(){
                                        $("#encuesta-campus-pascua-2019-form-respuesta").slideUp(500);
                                        $("#encuesta-campus-pascua-2019-form-respuesta").html("");
                                    });
                                    setTimeout("location.href = 'index.php';", 5000);
                                }
                                else if(data.response==="error"){
                                    $('#encuesta-campus-pascua-2019-form-respuesta').html("<div class='alert alert-danger w-100' style='padding:1.5em 1em;width:100%;font-size:1.3em;'>" + data.message + "</div>");
                                    $("#encuesta-campus-pascua-2019-form-respuesta").fadeTo(4000, 500).slideUp(500,function(){
                                        $("#encuesta-campus-pascua-2019-form-respuesta").slideUp(500);
                                        $("#eencuesta-campus-pascua-2019-form-respuesta").html("");
                                    });
                                }
                            }
                        });
