							...
							<div class="row">
								<div class="col-12 text-center">
									<h2 class="section-title mt-0 mb-0" style="color: #406da4;">
										<i class="fa fa-tree" aria-hidden="true" style="margin-right: 10px;"></i><b>ESCUELA NAVIDAD L´ALQUERIA</b>
									</h2>
								</div>
								...
								<div class="col-12">
									...
									<form action="?r=campus/ExportToExcelEscuelaNavidadAlq" method="post">
											...
											<?php
												foreach ($datos['inscripciones'] as $inscripcion) {
													...
													echo '<tr id="' . $inscripcion['id'] . '">
															...
															<td class="text-center">
																<form method="post" action="?r=campus/ModificaPagadoEscuelaNavidadAlq">';
															...
															<td class="text-center">
																...
																<a href="?r=escuelanavidad/ImprimirFichaEscuelaNavidadAlq&numeropedido='.$inscripcion['numeropedido'].'&tipopago='.$inscripcion['tipopago'].'" target="_blank">
															...
															<td class="text-center">
																<form method="post" action="?r=escuelanavidad/DardeBajaEscuelaNavidad">';
		...
		<script>
			$('document').ready(function () {
                ...
                $('body').on('click','.cargar_modal_editar_inscripcion',function()
                {
                    ...
                    $.ajax({
                        type:       "POST",
                        url:        "?r=escuelanavidad/MostrarModalEscuelaNavidad",
                        data:       form_data,
                        dataType:   "json",
					...
					submitHandler: function(form)
					{
				      ...
				      // 	formData.append("transporte", 		$('#transporte-editar-inscripciones').val()); 
				       ...
				       // formData.append("operaciones", 		$('#operaciones-editar-inscripciones').val()); 
						...
						$.ajax({
                            type:           "POST",
                            url:            "?r=escuelanavidad/UpdateInscripcionModalEscuelaNavidad",
                            data:           formData,
