								...
								<div class="col-md-12">
									<div class="text-wrap">
										<h2 class="section-title">
											<span class="orange-text"><?php echo $lang["ins_escuela_tpv_ok_1"];?></span>
										</h2>
									</div>
								</div>

								<div class="col-md-12 alqueria-bg-box">
									<h4 class="t-center"><?php echo $lang["ins_escuela_confirmacion"];?></h4>

									<h4 class="t-center"><?php echo $lang["ins_escuela_tpv_ok_3"];?></h4>

									<a class="btn btn-link-o" target="_blank" href="./inscripciones/<?php echo $datos["ruta_pdf"];?>">
										<span style="margin-top: 15px;"><?php echo $lang["ins_escuela_tpv_ok_4"];?></span>
									</a>
								</div>
							</div>
						</div>
