							...
							<div class="row">
								<div class="col-12 text-center">
									<h2 class="section-title mt-0 mb-0" style="color: #406da4;">
										<i class="fa fa-dribbble" aria-hidden="true" style="margin-right: 10px;"></i><b>SHOOTING ACADEMY</b>
									</h2>
								...
								<div class="col-12">
									...
									<form action="?r=shootingcamp/ExportToExcelShootingCamp" method="post">
									...
									<form action="?r=shootingcamp/ExportToExcelShootingCompleto" method="post">
								...
								<div class="col-12 text-left">
									...
									<p>
										<br>
										<b>Nº de inscritos:  <?php echo $datos['numerototalinscripciones']; ?> (Pensión completa: <?php echo $datos['inscripciones_pcompleta'][0]; ?> , Comida incluida: <?php echo $datos['inscripciones_solocomida'][0]; ?> )</b>
										<br>
									</p>
								</div>
											...
											<?php
												foreach ($datos['inscripciones'] as $inscripcion) {
													...
													echo '<tr id="' . $inscripcion['id'] . '">
															...
															<td class="text-center">
																<form method="post" action="?r=shootingcamp/ModificaPagadoShootingCamp">';
															...
															<td class="text-center">
																...
																<a href="?r=shootingcamp/ImprimirFicha&numeropedido='.$inscripcion['numero_pedido'].'&tipopago='.$inscripcion['tipo_pago'].'" target="_blank">
															...
															<!-- <td class="text-center">
																<form method="post" action="?r=shootingcamp/DardeBajaCampusShootingCamp">';
									...
									<div class="col-12 mb-1 t-left" style="font-size: 1.2em;">
										<div class="col-12 mb-1 t-left" style="font-size: 15px;">
											<label class="control control--radio">
												...
												Jugadores Internos: 750€ (Pensión completa)			
											</label>
										</div>
										...
										<div class="col-12 mb-1 t-left" style="font-size: 15px;">
											<label class="control control--radio">
												...
												Jugadores Externos: 360€ (Comida incluida)
											</label>
										</div>

										<div class="col-12 mb-1 t-left" style="font-size: 15px;">
											<label class="control control--radio">	
												<input type="radio" name="opcion" value="jugadores_internos_club" id="jugadores_internos_club" >
												Jugadores Internos Valencia BC: 637,5€ (Pensión completa)
											</label>
										</div>

										<div class="col-12 mb-1 t-left" style="font-size: 15px;">
											<label class="control control--radio">
												<input type="radio" name="opcion" value="jugadores_externos_club" id="jugadores_externos_club" >
												Jugadores Externos Valencia BC: 306€ (Comida incluida)
											</label>
										</div>
		...
		<script>
			$('document').ready(function () {
                ...
                $('body').on('click','.cargar_modal_editar_inscripcion',function()
                {
                    ...
                    $.ajax({
                        type:       "POST",
                        url:        "?r=shootingcamp/MostrarModalShooting",
                        data:       form_data,
                        dataType:   "json",
                        success:    function(data)
                        {
                            if(data.response==="success")
                            {
								...
								if (data.instancia['opcion']=="jugadores_internos"){
                                   
                                    $("input[name=opcion][value='jugadores_internos']").prop("checked",true);

                                } else if (data.instancia['opcion']=="jugadores_externos") {
                                    
                                    $("input[name=opcion][value='jugadores_externos']").prop("checked",true);
                                
                                } else if (data.instancia['opcion']=="jugadores_internos_club") {
                                    
                                    $("input[name=opcion][value='jugadores_internos_club']").prop("checked",true);
                                
                            	} else if (data.instancia['opcion']=="jugadores_externos_club") {
                                    
                                    $("input[name=opcion][value='jugadores_externos_club']").prop("checked",true);
                                }
                ...
                $("#form_editar_inscripciones").validate(
				{
					...
					submitHandler: function(form)
					{
						...
						$.ajax({
                            type:           "POST",
                            url:            "?r=shootingcamp/UpdateInscripcionModalShooting",
                            data:           formData,
