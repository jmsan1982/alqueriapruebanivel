						...
						<div class="row">
							<div class="col-12">
								<h3 class="section-title">
									<span class="orange-text">Declaración responsable para la asistencia a eventos y actividades de Proveedores</span>
								</h3>
							</div>
						</div>
									...
									<div class="row mt-1 renovacion-row">
										...
										<div class="col-12">
											...
											<div class="row">
												...
												<div class="form-group col-12 col-md-12 col-lg-5 col-xl-6">
													<label>Nombre del proveedor</label>
													<input type="text" class="form-control input-control-dni" name="nombreproveedor" id="nombreproveedor-form" maxlength="200">
												</div>
											</div>
										</div>
									</div>
			...
			$('#declaracion-responsable-form').validate(
			{
				submitHandler:function()
				{
                      ...
                      )
                    {
                        ...
                        formData.append("nombreproveedor", 		$("#nombreproveedor-form").val());
                        ...
                        {
                            type:           "POST",
                            url:            "?r=index/DeclaracionResponsableGestionaFormProveedores",
                            data:           formData,
