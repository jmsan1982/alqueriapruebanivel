	...
	<body class="Pages" id="formus">
						...
						<div class="row">
							<div class="col-12">
								<h3 class="section-title">
									<span class="orange-text">Declaración responsable para la asistencia a eventos deportivos de L'alqueria del basket</span>
								</h3>
							</div>
						</div>
							...
							<div class="col-12">
								<form id="declaracion-responsable-form" class="boxed-form" method="post">
									...
									<div class="row renovacion-row">
										<div class="col-12">
											...
											<ul style="font-size: 16px;">
												...
												<li>En caso de asistir durante la temporada 2020-2021 a nuevos eventos o actividades organizados en L'ALQUERIA DEL BASKET, me comprometo a cumplir igualmente con todo lo anteriormente descrito.</li>
											</ul>
									...
									<div class="row mt-1 renovacion-row">
										...
										<div class="col-12">
											...
											<div class="row">
												...
												<div class="form-group col-12 col-md-3 col-lg-3 col-xl-3">
													<label>E-mail</label>
													<input type="email" class="form-control input-control-dni" name="email" id="email-form" maxlength="200" required>
												</div>
												...
												<div class="col-12 col-md-12 col-lg-7 col-xl-6 mt-1">
													<label class="containerchekbox">
														<input type="checkbox" name="equipoPartido" value="1" id="equipoPartido-form">
														<p>Si pertenece a algún equipo y va a jugar algún partido, marque esta casilla.</p>
                                                ...
                                                <div class="col-12 col-md-12 col-lg-7 col-xl-6 mt-1">
                                                    <label class="containerchekbox">
                                                        <input type="checkbox" name="pistaResponsable" value="1" id="pistaResponsable-form">
                                                        <p>Si ha alquilado una pista, marque esta casilla .</p>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-12 col-lg-7 col-xl-6 mt-1">
                                                    <label class="containerchekbox">
                                                        <input type="checkbox" name="visitaInstalaciones" value="1" id="visitaInstalaciones-form">
                                                        <p>Si va a hacer una visita a las instalaciones, marque esta casilla.</p>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-12 col-lg-7 col-xl-6 mt-1">
                                                    <label class="containerchekbox">
                                                        <input type="checkbox" name="arbitro" value="1" id="arbitro-form">
                                                        <p>Si es usted un arbitro, marque esta casilla.</p>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>

                                                <div class="col-12 col-md-12 col-lg-12 col-xl-12 mt-1">
                                                    <label class="containerchekbox">
                                                        <input type="checkbox" name="oficialMesa" value="1" id="oficialMesa-form">
                                                        <p>Si es usted un oficial de mesa, marque esta casilla.</p>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>

												<div class="form-group col-12 col-md-12 col-lg-7 col-xl-6 mt-1" style="display: none;" id="explicacionTexto">
													<label>Introduzca el nombre de su equipo</label>
													<input type="text" class="form-control input-control-dni" name="detallesFormulario" id="detallesFormulario-form" maxlength="200">
												</div>

                                                <div class="col-12 col-md-12 col-lg-7 col-xl-6 mt-1" style="display: none;" id="responsableEquipo">
                                                    <label class="containerchekbox">
                                                        <input type="checkbox" name="responsableDelEquipo" value="1" id="responsableDelEquipo-form">
                                                        <p>¿Es usted el responsable del equipo? .</p>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>


                                                <div class="form-group col-12 col-md-12 col-lg-7 col-xl-6 mt-1" style="display: none;" id="nombreResponsableText">
                                                    <label>Introduzca el nombre del responsable quien alquilo la pista(Si no es usted)</label>
                                                    <input type="text" class="form-control input-control-dni" name="nombreResponsableText" id="nombreResponsableText-form" maxlength="200">
                                                </div>

                                                <div class="col-12 col-md-12 col-lg-7 col-xl-6 mt-1" style="display: none;" id="checkResponsableText">
                                                    <label class="containerchekbox">
                                                        <input type="checkbox" name="responsableDelEquipo" value="1" id="checkResponsableText-form">
                                                        <p>¿Es usted el responsable de la pista? .</p>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>

                                                <div class="row renovacion-row"  style="display: none" id="derechosStream">
                                                    <div class="col-12">
                                                        <p style="font-size: 16px;">AUTORIZACIÓN TRATAMIENTO IMÁGENES</p>
                                                        <ul style="font-size: 16px;">
                                                            <li><p>Dada la imposibilidad de acceso a la instalación para los acompañantes de los equipos, L’Alqueria del Basket pone a su disposición un servicio de streaming de los partidos a través de un enlace que podrán encontrar en el banner “partidos de la jornada” de nuestra web www.alqueriadelbasket.com al que podrán acceder de manera gratuita. Se le informa que las imágenes de los partidos podrán ser utilizadas en las redes sociales y medios de difusión de Valencia Basket Club, S.A.D.y/o Fundació Valencia Basquet 2000. En caso de no recabarse la autorización de todos los participantes en el encuentro, éste NO será retransmitido.</p></li>
                                                            <li><p id="textoStream"></p></li>
                                                        </ul>
                                                        <label class="containerchekbox">
                                                            <input type="checkbox" name="streaming" value="1" id="streaming-form">
                                                            <p>¿Acepta las condiciones expuestas anteriormente? .</p>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        </div>
                                                </div>
									...
									<div class="row mt-1 renovacion-row">
										...
										<div id="revisar-firma-container" class="col-12 mt-1" style="display:none;">
											<div class="alert alert-danger" role="alert">
												<h4><i class="fa fa-info-circle" aria-hidden="true"></i> Ha habido un error.</h4>
											</div>
										</div>
		...
		<script>
			...
			$('#declaracion-responsable-form').validate(
			{
				submitHandler:function()
				{
                      ...
                      )
                    {
                        ...
                        formData.append("pistaResponsable",	    $('#pistaResponsable-form').prop('checked'));
                        formData.append("equipoPartido", 	    $('#equipoPartido-form').prop('checked'));
                        formData.append("visitaInstalaciones", 	$('#visitaInstalaciones-form').prop('checked'));
                        formData.append("responsable", 	        $('#responsableDelEquipo-form').prop('checked'));
                        formData.append("streaming", 	        $('#streaming-form').prop('checked'));
                        formData.append("arbitro", 	        $('#arbitro-form').prop('checked'));
                        formData.append("oficialMesa", 	        $('#oficialMesa-form').prop('checked'));
                        formData.append("nombreEquipo",    	    $("#detallesFormulario-form").val());
                        formData.append("nombreResponsable",    $("#nombreResponsableText-form").val());
                        formData.append("firma_tutor", 			$("#img_firma_tutor").val());

                        $.ajax(
                        {
                            type:           "POST",
                            url:            "?r=index/DeclaracionResponsableAlqueriaGestionaForm",
                            data:           formData,
			...
			**************************************/ 
			...
			var isOn = false;
            var isOnDeclaracion = false;
            var isOnPista = false;

			$('#equipoPartido-form').on('change', function(){
			    $('#pistaResponsable-form').prop( "checked", false );
			    $('#visitaInstalaciones-form').prop( "checked", false );
                $('#arbitro-form').prop( "checked", false );
                $('#oficialMesa-form').prop( "checked", false );
				if (!isOn) {
					$('#explicacionTexto').fadeIn(150);
					$('#responsableEquipo').fadeIn(150);
					isOn = true;
				}
				else {
				 	$('#explicacionTexto').fadeOut(150);
                    $('#responsableEquipo').fadeOut(150);
				 	isOn = false;
				}
			});
            $('#pistaResponsable-form').on('change', function(){
                $('#equipoPartido-form').prop( "checked", false );
                $('#visitaInstalaciones-form').prop( "checked", false );
                $('#arbitro-form').prop( "checked", false );
                $('#oficialMesa-form').prop( "checked", false );
                if (isOn) {
                ...
                if (!isOnPista) {
                    $('#nombreResponsableText').fadeIn(150);
                    $('#checkResponsableText').fadeIn(150);
                    isOnPista = true;
                } else {
                    $('#nombreResponsableText').fadeOut(150);
                    $('#checkResponsableText').fadeOut(150);
                    isOnPista = false;
                }
            });
            $('#visitaInstalaciones-form').on('change', function(){
                $('#equipoPartido-form').prop( "checked", false );
                $('#pistaResponsable-form').prop( "checked", false );
                $('#arbitro-form').prop( "checked", false );
                $('#oficialMesa-form').prop( "checked", false );
            ...
            $('#arbitro-form').on('change', function(){
                $('#equipoPartido-form').prop( "checked", false );
                $('#pistaResponsable-form').prop( "checked", false );
                $('#visitaInstalaciones-form').prop( "checked", false );
                $('#oficialMesa-form').prop( "checked", false );
            ...
            $('#oficialMesa-form').on('change', function(){
                $('#equipoPartido-form').prop( "checked", false );
                $('#pistaResponsable-form').prop( "checked", false );
                $('#arbitro-form').prop( "checked", false );
                $('#visitaInstalaciones-form').prop( "checked", false );
            ...
            $('#nombrecompleto-form').on('change', function() {
                $('#textoStream').text('D. '+$('#nombrecompleto-form').val()+', con DNI '+$('#dni-form').val()+'COMO RESPONSABLE DEL EQUIPO '+$('#detallesFormulario-form').val()+' DECLARO HABER RECABADO EL CONSENTIMIENTO AL TRATAMIENTO Y USO DE LAS IMÁGENES DE TODOS LOS PARTICIPANTES EN EL ENCUENTRO QUE FIGURAN EN LA RELACIÓN ADJUNTA O DE SUS TUTORES O REPRESENTANTES LEGALES Y AUTORIZO EL USO DE LAS MISMAS CONFORME A LO ANTERIORMENTE DESCRITO');
            });

            $('#dni-form').on('change', function() {
                $('#textoStream').text('D. '+$('#nombrecompleto-form').val()+', con DNI '+$('#dni-form').val()+'COMO RESPONSABLE DEL EQUIPO '+$('#detallesFormulario-form').val()+' DECLARO HABER RECABADO EL CONSENTIMIENTO AL TRATAMIENTO Y USO DE LAS IMÁGENES DE TODOS LOS PARTICIPANTES EN EL ENCUENTRO QUE FIGURAN EN LA RELACIÓN ADJUNTA O DE SUS TUTORES O REPRESENTANTES LEGALES Y AUTORIZO EL USO DE LAS MISMAS CONFORME A LO ANTERIORMENTE DESCRITO');
            });

            $('#detallesFormulario-form').on('change', function() {
                $('#textoStream').text('D. '+$('#nombrecompleto-form').val()+', con DNI '+$('#dni-form').val()+'COMO RESPONSABLE DEL EQUIPO '+$('#detallesFormulario-form').val()+' DECLARO HABER RECABADO EL CONSENTIMIENTO AL TRATAMIENTO Y USO DE LAS IMÁGENES DE TODOS LOS PARTICIPANTES EN EL ENCUENTRO QUE FIGURAN EN LA RELACIÓN ADJUNTA O DE SUS TUTORES O REPRESENTANTES LEGALES Y AUTORIZO EL USO DE LAS MISMAS CONFORME A LO ANTERIORMENTE DESCRITO');
            });

            $('#responsableDelEquipo-form').on('change', function() {
                if (!isOnDeclaracion) {
                    $('#derechosStream').fadeIn(150);
                    isOnDeclaracion = true;
                } else {
                    $('#derechosStream').fadeOut(150);
                    isOnDeclaracion = false;
                }
            });

            $('#checkResponsableText-form').on('change', function(){
                $('#nombreResponsableText-form').prop('value',$('#nombrecompleto-form').val());
            });
