						...
						<div class="row">
							<div class="col-12">
								<h3 class="section-title">
									<span class="orange-text">Declaración responsable para la asistencia a eventos y actividades de VIP</span>
								</h3>
							</div>
						</div>
			...
			$('#declaracion-responsable-form').validate(
			{
				submitHandler:function()
				{
                      ...
                      )
                    {
                        ...
                        {
                            type:           "POST",
                            url:            "?r=index/DeclaracionResponsableGestionaFormVIP",
                            data:           formData,
