                        ...
                        <div class="row mb-2">
                            <div class="col-12 t-center">
                                <h2 class="section-title mb-0">
                                    Encuesta <span class="orange-text">Entrenadores</span>
                                </h2>
                            </div>
                            ...
                            <div class="col-12">
                                <p>A continuación, encontrarás una serie de preguntas destinadas a conocer tu opinión sobre diversos aspectos del L’Alqueria del Basket. Mediante ellas queremos conocer lo que piensan nuestros entrenadores sobre nosotros.</p>
                                <p>Esta encuesta es <u>anónima</u>, y tardarás <u>menos de 5 minutos</u> en contestarla. Por favor, lee detenidamente cada pregunta y contesta la alternativa que más se acerca a lo que piensas. Muchas gracias.</p>
                            </div>
                        </div>

                        <!-- Encuesta -->
                        <div class="row">
                            <form id="encuesta-entrenadores-form" class="boxed-form" method="post">
                                <div class="form-group col-12">
                                    <div class="row"> 

                                        <?php
                                        foreach ($datos["entrenadores"] as $pregunta ) {
