                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form id="contactform" enctype="multipart/form-data" action="?r=escuelafallas/EscuelaFallasForm" class="boxed-form" name="contactform" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-12 mb-1 t-left" style="font-size: 1.2em;">
                                                    <label class="control control--radio mb-1">
                                                        OPCIÓN A: Sólo mañanas de 8:30 a 14:00h.(50€)
                                                        <input type="radio" name="opcion" value="solomanyana" checked required>
                                                        <div class="control__indicator"></div>
                                                    </label>

                                                    <label class="control control--radio mb-1">
                                                        OPCIÓN B: Días completos de 8:30 a 18:00h. (80€)
                                                 ...
                                                 <div class="col-12 t-left" style="font-size:1.2em;display:none;" id="diassueltos">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-9 " id="capa1" style="font-size:0.8em;display:none;">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="rdia1" value="dia16-manyana" checked>Solo mañana  &nbsp;   &nbsp;

                                                            </label>
                                                            <label class="radio-inline">
                                                                 <input type="radio" name="rdia1" value="dia16-completo">Día completo
                                                            </label>
                                                        </div>
                                                   </div>
                                                   ...
                                                   <div class="row">
                                                        ...
                                                        <div class="col-9 " id="capa2" style="font-size:0.8em;display:none;">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="rdia2" value="dia17-manyana" checked>Solo mañana   &nbsp;   &nbsp;
                                                            </label>
                                                            <label class="radio-inline">
                                                                 <input type="radio" name="rdia2" value="dia17-completo">Día completo
                                                            </label>
                                                        </div>
                                                   </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-9 " id="capa3" style="font-size:0.8em;display:none;">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="rdia3" value="dia18-manyana" checked>Solo mañana  &nbsp;   &nbsp;
                                                            </label>
                                                            <label class="radio-inline">
                                                                 <input type="radio" name="rdia3" value="dia18-completo">Día completo
                                                            </label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="contact-info-wrap t-center">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <p class="t-center">
                                                            <strong>Para más información puede contactar con el 615557377 o en servicios.alqueriadelbasket.com </strong> <a target='_blank' style='color:black;text-decoration:underline;' href='https://servicios.alqueriadelbasket.com/documentos/Dosier-Padres-Escuela-Fallas-Alqueria.pdf'>Ver dosier informativo</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <p class="t-left"><strong>Autorizo a la Dirección de la I Escuela de Fallas 2021 de L´Alqueria del Basket, en caso de máxima urgencia con el consentimiento y prescripción médica a tomar las decisiones médico-quirúrgicas necesarias, si ha sido imposible mi localización.</strong></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <label class="containerchekbox">
                                            ...
                                            <p>Como administrador de L'Alqueria del Basket en la I Escuela de Fallas 2021 acepto las condiciones anteriormente expuestas.</p>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
