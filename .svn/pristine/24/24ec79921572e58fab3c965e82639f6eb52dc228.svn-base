						...
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									<div class="text-wrap">
										<h2 class="section-title">
											<span class="orange-text">Pago no completado</span>
										</h2>
									</div>
								</div>
								...
								<div class="col-md-12 alqueria-bg-box">
									<h4 class="t-center">
										Ha habido algún problema con la pasarela de pago de la inscripción.
									</h4>

									<h4 class="t-center">
										Inténtalo de nuevo pasados unos minutos o prueba otro método de pago. Si no lo consigues, ponte en contacto con recepción de L´Alqueria del Basket en el +34 961 215 543.
									</h4>

									<a class="btn btn-link-o" href="https://www.valenciabasket.com/campusnavidad/">
										<span style="margin-top: 15px;">Volver a inscripciones</span>
									</a>
									<br>
								</div>
							</div>
