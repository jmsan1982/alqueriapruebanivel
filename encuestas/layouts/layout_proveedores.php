            ...
            <section id="page-content" class="overflow-x-hidden">
                ...
                <div class="block background-f6">
                    <div class="container">
                        ...
                        <div class="row mb-2">
                            <div class="col-12 t-center">
                                <h2 class="section-title mb-0">
                                    Encuesta <span class="orange-text">Proveedores</span>
                                </h2>
                            </div>
                            ...
                            <div class="col-12">
                                <p>A continuación, encontrará una serie de preguntas destinadas a conocer su opinión sobre diversos aspectos del L’Alqueria del Basket. Mediante ellas queremos conocer lo que piensan nuestros proveedores sobre nosotros.</p>
                        ...
                        <!-- Encuesta -->
                        <div class="row">
                            <form id="encuesta-proveedores-form" class="boxed-form" method="post">
                                <div class="form-group col-12">
                                    <div class="row"> 

                                        <?php
                                        foreach ($datos["proveedores"] as $pregunta ) {
