...
$id = $_GET['pedido'];
/*
$url="http://localhost/serviciosalqeria2/tpv_campus_ibza/ejemploRecepcionaPet.php";
$urlOK="http://localhost/serviciosalqeria2/tpv_campus_ibza/ejemploRecepcionaPet.php";
$urlKO="http://localhost/serviciosalqeria2/tpv_campus_ibza/ejemploRecepcionaPet.php";
*/


//entorno real

$url="https://servicios.alqueriadelbasket.com/tpv_campus_ibiza/ejemploRecepcionaPet.php";
$urlOK="https://servicios.alqueriadelbasket.com/tpv_campus_ibiza/ejemploRecepcionaPet.php";
$urlKO="https://servicios.alqueriadelbasket.com/tpv_campus_ibiza/ejemploRecepcionaPet.php";
...
//valores fijos
$concepto = 'Campus Ibiza 2020';   //maximo 125 caracteres
