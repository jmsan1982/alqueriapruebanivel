							...
							<div class="row">
								<div class="col-12 text-center">
									<h2 class="section-title mt-0 mb-0" style="color: #406da4;">
										<i class="fa fa-star-o" aria-hidden="true" style="margin-right: 10px;"></i><b>IMPROVE TALENT</b>
									</h2>
								</div>
								...
								<div class="col-12">
									...
									<form action="?r=campusimprove/ExportToExcelImproveTalent" method="post">
											...
											<?php
												foreach ($datos['inscripciones'] as $inscripcion) {
													...
													echo '<tr id="' . $inscripcion['id'] . '">
															...
															<td class="text-center">
																<form method="post" action="?r=campusimprove/ModificaPagadoImproveT">';
															...
															<td class="text-center">
																<a href="?r=campusimprove/ImprimirFicha&numeropedido='.$inscripcion['numero_pedido'].'&tipopago='.$inscripcion['tipo_pago'].'" target="_blank">
															...
															<td class="text-center">
																<form method="post" action="?r=campusimprove/DardeBajaCampusImproveTalent">';
