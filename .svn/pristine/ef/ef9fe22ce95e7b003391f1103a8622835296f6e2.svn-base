                    ...
                    <div class="b-wrap-club-gallery">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-12 alqueria-bg-box mt-3">
                                    
                                        <h4 class="t-center">
                                            Ha realizado la inscripción correctamente pero ha fallado el envío de correo con la información de su inscripción.
                                        </h4>

                                        <h4 class="t-center">
                                           Puede ponerse en contacto con el Club.
                                        </h4>

                                        <a class="btn btn-link-o" href="https://servicios.alqueriadelbasket.com/" style="width:50%;">
                                            <span style="margin-top:15px;">
                                              Regresar a la página de inscripciones
                                            </span>
                                        </a>
                                    </div>
