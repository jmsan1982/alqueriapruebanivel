...
// Valores de entrada que no cambian para ningun ejemplo
...
//URL DE PRUEBAS
// $url="http://localhost/alqueriaforms/tpv_worcester/ejemploRecepcionaPet.php";
// $urlOK="http://localhost/alqueriaforms/tpv_worcester/ejemploRecepcionaPet.php";
// $urlKO="http://localhost/alqueriaforms/tpv_worcester/ejemploRecepcionaPet.php";

//URL DE PRODUCCION
$url="https://servicios.alqueriadelbasket.com/tpv_worcester/ejemploRecepcionaPet.php";
$urlOK="https://servicios.alqueriadelbasket.com/tpv_worcester/ejemploRecepcionaPet.php";
$urlKO="https://servicios.alqueriadelbasket.com/tpv_worcester/ejemploRecepcionaPet.php";


//estos dos valores los vamos cambiando en cada ejemplo
//$id='01603494';//Nº de pedido, 4 primeros digitos numericos, el resto del 0 al 9 a-z, A-Z
$id = $_GET['pedido'];

//$titular = 'Campus worcester 2'; //$_POST['concepto'];  //maximo 60 caracteres
$titular = $_GET['titular'];


//valores fijos
$concepto = 'Reserva Campus Worcester';   //maximo 125 caracteres
$amount=10000;//importe a pagar. Las dos ultimas posiciones se consideran decimales (IMPORTE DE CAMPUS WORCESTER=100€)
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-12 t-center">
                                    <h3 class="section-title mb-1"><span class="orange-text"> Confirme la reserva </span></h3>
                                </div> 
                                ...
                                <div class="col-md-12">
                                   ...
                                   <!-- URL de llamada del entorno de test es:  https://sis-t.redsys.es:25443/sis/realizarPago     -->
                                    ...
                                    <div class="col-md-12">
                                        <img class="img-responsive mb-1" src="../img/tpv_worcester1.jpg" style="margin:0 auto;border:1px solid gray;">
                                    </div>
