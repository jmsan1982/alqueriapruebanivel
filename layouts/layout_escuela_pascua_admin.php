								...
								<div class="row">
									<div class="col-12 col-md-12 col-lg-12 col-xl-12" id="titulo">
										<h2 class="section-title">
											<span class="orange-text">5ª Escuela de Pascua 2021</span>
										</h2>
										<h4 class="section-title">6, 7, 8 y 9 de abril</h4>
										<!-- <h3 class="section-title mb-2">4 y 5 de enero</h3> -->
									</div>
								</div>

                                <div class="form-group mb-3">
                                    <div class="alert alert-success redimension" role="alert">
                                        <h4><i class="fa fa-info-circle" aria-hidden="true"></i> Inscripciones internas para admins de Alqueria</h4>
                                    </div>
                                </div>

								<form id="contactform" enctype="multipart/form-data" action="?r=escuelapascua/EscuelaPascuaForm" class="boxed-form" name="contactform" method="post">
									<!-- DÍAS A ELEGIR -->
									<div class="row">
												...
												<div class="row">
													<div class="col-12 mb-1 t-left" style="font-size: 15px;">
														<label class="control control--radio">
															OPCIÓN A: Sólo mañanas de 8:30 a 14:00h (60€)
													...
													<div class="col-12 mb-1 t-left" style="font-size: 15px;">
														<label class="control control--radio">
															OPCIÓN B: Días completos de 8:30 a 18:00h (100€)
												...
												<div class="contact-info-wrap t-center"> 
													<div class="row">
														...
														<div class="col-12">
                                                            ...
                                                            <p class="t-center">
                                                                <strong>Para más información puede contactar con el 615557377 o en servicios.alqueriadelbasket.com </strong> <a target='_blank' style='color:black;text-decoration:underline;' href='https://servicios.alqueriadelbasket.com/documentos/Dosier-Padres-Escuela-Pascua-Alqueria.pdf'>Ver dosier informativo</a>
                                                            </p>
														</div> 
													</div>                                                
												</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-12">
												<p class="t-left">
													<strong>Autorizo a la Dirección de la Escuela de Pascua de L'Alqueria del Basket, en caso de máxima urgencia con el consentimiento y prescripción médica a tomar las decisiones médico-quirúrgicas necesarias, si ha sido imposible mi localización.</strong>
												</p>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-12 redimension">
												<input type="file" id="fileName" class="form-control" style="border: none !important; padding: 0 !important;" name="fotocopiasip" aria-describedby="fileHelp" accept="image/gif,image/jpeg,image/jpg,image/png,image/bmp,application/pdf" onchange="validateFileType()">
											</div>
									...
									<div class="row">
                                        ...
                                        <div class="col-12">
                                            <label class="containerchekbox">
                                                <input type="checkbox" name="autorizo" value="si" class="input-control-dni" >
                                                <p>He leido y cumplimentado el <a target='_blank' style='color:black;text-decoration:underline;' href='https://servicios.alqueriadelbasket.com/documentos/Protocolo-Sanitario-Escuela-Pascua-Alqueria.pdf'>protocolo sanitario</a></p>
									...
									<div class="row">
										...
										<div class="col-12 mt-1 mb-1">
											<label class="containerchekbox">
												...
												<p>Como administrador de L'Alqueria del Basket en la Escuela de Pascua, acepto las condiciones anteriormente expuestas.</p>
												<span class="checkmark"></span>
											</label>
										</div>                                    
										...
										<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2">
											<button type="submit" class="btn btn-link-w w-100" style="width: 100%; margin-left: 0;" id="oficina" name="enviar" value="oficina">
												<span>Inscribir al participante</span>
											</button>
										</div>
