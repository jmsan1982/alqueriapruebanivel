...
/*
$url="http://localhost/serviciosalqueria/tpv_escuelanavidad/ejemploRecepcionaPet.php";
$urlOK="http://localhost/serviciosalqueria/tpv_escuelanavidad/ejemploRecepcionaPet.php";
$urlKO="http://localhost/serviciosalqueria/tpv_escuelanavidad/ejemploRecepcionaPet.php";
*/

//entorno real

$url="https://servicios.alqueriadelbasket.com/tpv_escuelanavidad/ejemploRecepcionaPet.php";  //entra por post
$urlOK="https://servicios.alqueriadelbasket.com/tpv_escuelanavidad/ejemploRecepcionaPet.php";  //entra por get
$urlKO="https://servicios.alqueriadelbasket.com/tpv_escuelanavidad/ejemploRecepcionaPet.php";
...
//valores fijos
$concepto = 'Escuela Navidad 2020';   //maximo 125 caracteres
