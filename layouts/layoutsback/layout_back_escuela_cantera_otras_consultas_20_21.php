                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div id="div-3" class="col-12 mt-2">
                            <!-- DOMICILIACIONES MATRÍCULAS. GENERAR XML 2020 / 2021 -->
                                   ...
                                   style="text-decoration: none;">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            DOMICILIACIONES MATRÍCULAS 2020 / 2021: GENERAR XML
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row pl-1 pr-1 ml-1 mr-1">
                                            ...
                                            <div class="col-12 mb-2">
                                                ...
                                                <p>- Estos cobros requieren una confirmación para validar que el banco
                                                    ha procesado el XML sin ningún error.</p>
                                                <p>- Los cobros también pueden anularse si por ejemplo el XML no se
                                                    envió al banco o si ocurrió un error al procesarse el fichero. Así,
                                                    los cobros se incluirán de nuevo en el siguiente XML que se
                                                    genere.</p>
                                            </div>
                                        ...
                                        <div class="row pl-1 pr-1 ml-1 mr-1">
                                            ...
                                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 pt-1 bg-warning">
                                                ...
                                                <p class="mt-1 text-justify">Al pulsar este botón se seleccionarán todas
                                            ...
                                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 pt-1 bg-success">
                                                ...
                                                <p class="mt-1 text-justify">Al confirmar el envío del XML, se indica
                                                ...
                                                <p class="mt-1 text-justify">Tras confirmarse las filas seleccionadas,
                                                    las filas desaparecerán de este listado cuando se refresque la
                                                    pantalla.</p>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 pt-1 bg-danger">
                                                ...
                                                <p class="mt-1 text-justify">Al anular el XML generado, se indica que el
                                                    envío del XML al banco no salió bien para las inscripciones
                                                    seleccionadas.</p>
                                                <p class="mt-1 text-justify">Así, se elimina el pago de la mátrícula de
                                                    la inscripción del XML y esta se incluirá en la futura generación de
                                                    XML.</p>
                                                <p class="mt-1 text-justify">Tras anular las filas seleccionadas, las
                                                    filas desaparecerán de este listado cuando se refresque la
                                                    pantalla.</p>
                                            </div>
