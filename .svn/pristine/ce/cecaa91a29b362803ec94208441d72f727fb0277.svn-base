...
<html lang="es">
    ...
    <body class="Pages gallery-W">
        <div class="wrapper">
                    ...
                    <div class="b-wrap-club-gallery">
                        <div class="container">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-12 alqueria-bg-box mt-4">
                                    
                                    <h4 class="t-center">
                                        La solicitud se ha realizado correctamente. 
                                    </h4>
                                    
                                    <a class="btn btn-link-o" href="index.php?r=index/LicenciaFederacion" style="width:50%;">
                                        <span style="margin-top:15px;">
                                            Regresar al formulario de solicitudes.
                                        </span>
                                    </a>
                                </div>
            ...
            <script>alert("La solicitud de se ha realizado correctamente. ¡Gracias!");</script>
