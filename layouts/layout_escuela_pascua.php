					...
					<div class="row">
						<div class="col-12">
							<div class="formulariocampusverano">
								...
								<div class="row">
									...
									<div class="col-12 col-md-12 col-lg-12 col-xl-12" id="titulo">
										<h2 class="section-title">
											<span class="orange-text">Regístrate en la 5ª Escuela de Pascua 2021</span>
										</h2>
								...
								<form id="contactform" enctype="multipart/form-data" action="?r=escuelapascua/EscuelaPascuaForm" class="boxed-form hidden" name="contactform" method="post">
									<!-- DÍAS A ELEGIR -->
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-12 mt-1 mb-1">
											<label class="containerchekbox">
												...
												<p>Como madre / padre / tutor, inscribo a mi hij@ en la Escuela de Pascua de L'Alqueria del Basket y acepto las condiciones anteriormente expuestas.</p>
												<span class="checkmark"></span>
											</label>
										</div>                                    
