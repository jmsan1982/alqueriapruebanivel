...
/*
$url="http://localhost/serviciosalqueria3/tpv_campusmuro/ejemploRecepcionaPet.php";
$urlOK="http://localhost/serviciosalqueria3/tpv_campusmuro/ejemploRecepcionaPet.php";
$urlKO="http://localhost/serviciosalqueria3/tpv_campusmuro/ejemploRecepcionaPet.php";
*/

//entorno real

$url="https://servicios.alqueriadelbasket.com/tpv_campusmuro/ejemploRecepcionaPet.php";
$urlOK="https://servicios.alqueriadelbasket.com/tpv_campusmuro/ejemploRecepcionaPet.php";
$urlKO="https://servicios.alqueriadelbasket.com/tpv_campusmuro/ejemploRecepcionaPet.php";
...
//valores fijos
$concepto = 'Campus Muro de los Sueños';   //maximo 125 caracteres
