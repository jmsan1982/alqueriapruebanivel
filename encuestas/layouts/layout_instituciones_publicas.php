            ...
            <section id="page-content" class="overflow-x-hidden">
                ...
                <div class="block background-f6">
                    <div class="container">
                        ...
                        <div class="row mb-2">
                            <div class="col-12 t-center">
                                <h2 class="section-title mb-0">
                                    Encuesta <span class="orange-text">Instituciones Públicas</span>
                                </h2>
                            </div>
                            ...
                            <div class="col-12">
                                <p>A continuación, encontrará una serie de preguntas destinadas a conocer su opinión sobre diversos aspectos del L’Alqueria del Basket. Mediante ellas queremos conocer lo que piensan los organismos públicos sobre nosotros.</p>
                        ...
                        <!-- Encuesta -->
                        <div class="row">
                            <form id="encuesta-institucionesPublicas-form" class="boxed-form" method="post">
                                <div class="form-group col-12">
                                    <div class="row">

                                        <div class="col-12">
                                            <h4 class="mt-0 mb-1">
                                                Nombre del organismo público (<strong>opcional</strong>):
                                            </h4>
                                        </div>
                                        ...
                                        <?php
                                        foreach ($datos["institucionesPublicas"] as $pregunta ) {
