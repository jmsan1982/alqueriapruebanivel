							...
							<div class="row">
								<div class="col-12 text-center">
									<h2 class="section-title mt-0 mb-0" style="color: #406da4;">
										<i class="fa fa-leaf" aria-hidden="true" style="margin-right: 10px;"></i><b>CAMPUS PASCUA</b>
									</h2>
								...
								<div class="col-12">
									...
									<form action="?r=campus/ExportToExcelCampusPascua" method="post">
									...
									<form action="?r=campus/ExportToExcelCampusPascuaCompleto" method="post">
								...
								<div class="col-12 text-left">
									...
									<p>
										<br>
										<b>Nº de inscritos:  <?php echo $datos['numerototalinscripciones']; ?> (Media pensión: <?php echo $datos['inscripciones_media'][0]; ?> , Completa: <?php echo $datos['inscripciones_completo'][0]; ?>) </b>
										<br>
									</p>
								</div>
												...
												foreach ($datos['inscripciones'] as $inscripcion) {
													...
													echo '<tr id="'.$inscripcion['id'].'">
															...
															<td class="text-center">';
																if(false !== strpos($inscripcion['fotocopiasip'], "sipcampuspascua_vb"))
                                                            	{
                                                                	echo '<a href="'.$inscripcion['fotocopiasip'].'" target="_blank">';
                                                                } else	{
                                                                	echo '<a href="https://www.valenciabasket.com/campuspascua/'.$inscripcion['fotocopiasip'].'" target="_blank">';
															...
															echo '<td class="text-center">';
																...
																if(false !== strpos($inscripcion['resguardopago'], "sipcampuspascua_vb"))
                                                            	{
                                                            		echo '<a href="'.$inscripcion['resguardopago'].'" target="_blank">';
                                                            	} else {
                                                            		echo '<a href="https://www.valenciabasket.com/campuspascua/'.$inscripcion['resguardopago'].'" target="_blank">';
                                                            	}	
															...
															echo '<td class="text-left">'.$inscripcion['pension'].'</td>
															<td class="text-center">' . $tipopago . '</td>
															<td class="text-center">' . $string_importe . '</td>
															<td class="text-center">
																<form method="post" action="?r=campus/ModificaPagadoCampusPascua">';
															...
															<td class="text-center">
																...
																<a href="?r=campus/ImprimirFichaCampusPascua&numeropedido='.$inscripcion['numeropedido'].'&tipopago='.$inscripcion['tipo_pago'].'" target="_blank">
															...
															<td class="text-center">
																<form method="post" action="?r=campus/DardeBajaCampusPascua
																">
																	<input type="hidden" name="id" value="'.$inscripcion['numeropedido'].'"> 
						...
						<div class="container-fluid">
							<div class="row mt-1">
								...
								<div class="form-group col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
									<label for="tallacamiseta-editar-inscripciones" class="labelForm">Talla camiseta:</label>
									<input type="text" class="form-control inputForm valid" value="" id="tallacamiseta-editar-inscripciones" name="tallacamiseta-editar-inscripciones" placeholder="Apellidos" aria-invalid="false">
								</div>
							</div>
							...
							<div class="clearfix"></div>
							 ...
							 <div class="row">
								...
								<div class="form-group col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
									<label for="alergias-editar-inscripciones" class="labelForm">Alergias:</label>
								...
								<div class="form-group col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
									<label for="operaciones-editar-inscripciones" class="labelForm">Operaciones recientes:</label>
									<input type="text" class="form-control inputForm valid" value="" id="operaciones-editar-inscripciones" name="operaciones-editar-inscripciones" placeholder="Operaciones recientes" aria-invalid="false">
								</div>
							...
							<div class="row">
								...
								<div class="form-group col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
									<label for="observ-editar-inscripciones" class="labelForm">Observaciones (dormir con):</label>
								...
								<div class="form-group col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
									...
									<div class="col-12 mb-1 t-left" style="font-size: 1.2em;">
										<label class="control control--radio mb-1">
											Media Pensión Externo (140€)
											<input type="radio" name="opcion" value="media" id="media" checked required>
											<div class="control__indicator"></div>
										</label>
										<br>
										<label class="control control--radio mb-1">
											Pensión completa Externo (165€)
											<input type="radio" name="opcion" value="completa" id="completa" >
											<div class="control__indicator"></div>
										</label>
										<br>
										<label class="control control--radio mb-1">
											Media Pensión Club (115€)
											<input type="radio" name="opcion" value="mediaclub" id="mediaclub">
											<div class="control__indicator"></div>
										</label>
										<br>
										<label class="control control--radio mb-1">
											Pensión completa Club (140€)
											<input type="radio" name="opcion" value="completaclub" id="completaclub">
											<div class="control__indicator"></div>
										</label>
		...
		<script>
			$('document').ready(function () {
                ...
                $('body').on('click','.cargar_modal_editar_inscripcion',function()
                {
                    ...
                    $.ajax({
                        type:       "POST",
                        url:        "?r=campus/MostrarModalCampusPascua",
                        data:       form_data,
                        dataType:   "json",
                        success:    function(data)
                        {
                            if(data.response==="success")
                            {
                                ...
                                $("#tallacamiseta-editar-inscripciones").val(data.instancia['tallacamiseta']);
								...
								// $("#opcion-editar-inscripciones").val(data.instancia['pension']);
								$("#importe-editar-inscripciones").val(data.instancia['importe']);

								//recogemos el tipo de inscripcion
								if (data.instancia['pension']=="media"){
                                   
                                    $("input[name=opcion][value='media']").prop("checked",true);

                                } else if (data.instancia['pension']=="completa") {
                                    
                                    $("input[name=opcion][value='completa']").prop("checked",true);
                                
                                } else if (data.instancia['pension']=="mediaclub") {
                                    
                                    $("input[name=opcion][value='mediaclub']").prop("checked",true);
                                } else if (data.instancia['pension']=="completaclub") {
                                    
                                    $("input[name=opcion][value='completaclub']").prop("checked",true);
                                }
				...
				//  Modal Editar Inscripcion /  guardar cambios
                $("#form_editar_inscripciones").validate(
				{
					...
					submitHandler: function(form)
					{
				        ...
				        formData.append("tallacamiseta", 	$('#tallacamiseta-editar-inscripciones').val());  
						...
						$.ajax({
                            type:           "POST",
                            url:            "?r=campus/UpdateInscripcionModalCampusPascua",
                            data:           formData,
