...
/*
$url="http://localhost/alqueriaforms/tpv_escuelaverano/ejemploRecepcionaPet.php";
$urlOK="http://localhost/alqueriaforms/tpv_escuelaverano/ejemploRecepcionaPet.php";
$urlKO="http://localhost/alqueriaforms/tpv_escuelaverano/ejemploRecepcionaPet.php";
*/

//entorno real

$url="https://servicios.alqueriadelbasket.com/tpv_escuelaverano/ejemploRecepcionaPet.php";
$urlOK="https://servicios.alqueriadelbasket.com/tpv_escuelaverano/ejemploRecepcionaPet.php";
$urlKO="https://servicios.alqueriadelbasket.com/tpv_escuelaverano/ejemploRecepcionaPet.php";
...
//valores fijos
$concepto = 'Escuela Verano Alqueria 2021';   //maximo 125 caracteres
