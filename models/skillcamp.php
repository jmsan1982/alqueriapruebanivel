<?php
	class skillcamp {
		...
		public static function mailssendSkillscamp($numeropedido, $contenido, $seccioninscripcion, $email) {
			...
			$mail->AddAddress($email, 'Inscripción Skills Camp 2019');

			// Con copia oculta
			$mail->AddBCC('actividades@valenciabasket.com', 'Inscripción Skills Camp 2019');
			$mail->AddBCC('recepcion@alqueriadelbasket.com', 'Inscripción Skills Camp 2019');
