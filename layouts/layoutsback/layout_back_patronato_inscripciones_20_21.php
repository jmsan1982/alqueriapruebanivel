                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <h2 class="section-title mt-0 mb-0" style="color: #406da4;">
                                <i class="fa fa-home" aria-hidden="true" style="margin-right: 10px;"></i><b>Patronato 20/21</b>
                            </h2>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <form action="?r=jugadores/ExportToExcelInscripcionesPatronato" method="post">
...
<!-- Modal - Editar Pagos Trimestrales Patronato-->
...
<!-- Modal - Ver Pagos de jugadores-->
<div id="jugadores-pagos-modal" class="modal fade" role="dialog">
    <div class="modal-dialog" style="width:90%;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title mb-0 pt-0 pb-0">Informacion Pagos jugadores</h4>
            </div>
            <div class="modal-body">
                <div id="pagos-jugador-container" class="row">
                    <div id="pagos-jugador-mensaje" class="col-12">
                        <div class="alert alert-info">
                            Por favor, espere mientras se cargan los datos.
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Datos Pagos de Jugadores</div>
                    <div class="panel-body">
                        <table class="table" id="tabla-jugadores-pagos">
...
<script>
    $('document').ready(function () {
        ...
        $(".cargar_modal_editar_inscripcion_patronato").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: "?r=inscripciones/MostrarModalJugadorPatronato",
                data: form_data,
                dataType: "json",
