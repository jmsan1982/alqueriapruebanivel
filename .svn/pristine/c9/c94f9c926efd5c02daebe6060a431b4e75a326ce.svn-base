						...
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									<div class="text-wrap">
										<h2 class="section-title">
											<span class="orange-text">¡Gracias por confiar en nosotros!</span>
										</h2>
									</div>
								</div>
								...
								<div class="col-md-12 alqueria-bg-box">
									<h4 class="t-center">
										Tu solicitud de inscripción al Campus de navidad 2019 se ha realizado correctamente.
									</h4>

									<h4 class="t-center">
										Has debido recibir la información proporcionada en tu correo electrónico.
									</h4>
