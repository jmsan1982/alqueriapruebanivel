            ...
            <section id="page-content" class="overflow-x-hidden">
                ...
                <div class="block background-f6">
                    <div class="container">
                        ...
                        <div class="row mb-2">
                            <div class="col-12 t-center">
                                <h2 class="section-title mb-0">
                                    Encuesta <span class="orange-text">Jugadores</span>
                                </h2>
                            </div>
                            ...
                            <div class="col-12">
                                <p>A continuación, encontrarás una serie de preguntas destinadas a conocer tu opinión sobre diversos aspectos del L’Alqueria del Basket. Mediante ellas queremos conocer lo que piensan nuestros jugadores sobre nosotros.</p>
                        ...
                        <!-- Encuesta -->
                        <div class="row">
                            <form id="encuesta-jugadores-form" class="boxed-form" method="post">
                                <div class="form-group col-12">
                                    <div class="row"> 

                                        <?php
                                        foreach ($datos["jugadores"] as $pregunta ) {
