                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    <h2 class="section-title mt-0 mb-0" style="color: #406da4;">
                                        <i class="fa fa-sun-o" aria-hidden="true" style="margin-right: 10px;"></i><strong>ESCUELA VERANO L´ALQUERIA</strong>
                                    </h2>
                                ...
                                <div class="col-12">
                                    ...
                                    <form action="?r=escuelaverano/ExportToExcelEscuelaVeranoAlq" method="post">
                                    ...
                                    <form action="?r=escuelaverano/ExportToExcelEscuelaVeranoAlqCompleto" method="post">
                                    ...
                                    <table id="inscripciones-listado-datatable" class="table table-striped table-hover w-100 mb-2 inscripciones-jornadas-deteccion" style="width: 100%;">
                                        <thead class="table-dark">
                                            <tr style="cursor: pointer;">
                                              ...
                                              <!--  <th class="text-left">Dias sueltos</th> -->
                                            ...
                                            <?php
                                                foreach ($datos['inscripciones'] as $inscripcion) {
                                                    ...
                                                    echo '<tr id="'.$inscripcion['id'].'">
                                                          ...
                                                          <!--  <td class="text-left">' . $inscripcion['diassueltos']. '</td> -->
                                                            ...
                                                            <td class="text-center">'.$inscripcion['tipopago'].'</td>
                                                            <td class="text-center">'.$string_importe.'€</td>
                                                            <td class="text-center">
                                                                <form method="post" action="?r=escuelaverano/ModificaPagadoEscuelaVeranoAlq">';
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="?r=escuelaverano/ImprimirFichaEscuelaVeranoAlq&numeropedido='.$inscripcion['numeropedido'].'&tipopago='.$inscripcion['tipopago'].'" target="_blank">
                                                            ...
                                                            <td class="text-center">
                                                                <form method="post" action="?r=escuelaverano/DardeBajaEscuelaVeranoAlq">';
       ...
       <?php require "includes/footer_back.php"; ?>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <label for="tratamientosm-editar-inscripciones" class="labelForm">Observaciones médicas:</label>
                            ...
                            <div class="row">
                                <!-- <div class="form-group col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2" id="imgsip">
                                    <a href="" target="_blank""><img  src="https://servicios.alqueriadelbasket.com/" class="img1" width="50" height="50"/></a> 
                                </div> -->
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 t-left" style="font-size: 1.2em;">
                                    <label class="containerchekbox">
                                        ...
                                        <span class="checkmark"></span> 1º turno: del 28 junio al 2 de julio
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 mb-1" id="capa2" style="font-size: 14px; ">  <!-- display: none; -->
                                    <label class="radio-inline pr-1">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5 t-left" style="font-size: 1.2em;">
                                    <label class="containerchekbox">
                                        ...
                                        <span class="checkmark"></span>3º turno: del 12 al 16 de Julio
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <input type="text" class="form-control inputForm valid" value="" id="diass-editar-inscripciones" name="diass-editar-inscripciones" placeholder="" aria-invalid="false" disabled>
                                </div>
        ...
        <!-- SCRIPT PARA MOSTRAR LAS OPCIONES AL SELECCIONAR LA SEMANA -->
                                        <script type="text/javascript">
                                          ...
                                          /*  $('[name="turno2"]').change(function(){
                                                $("#capa2").toggle();
                                            });

                                            $('[name="turno3"]').change(function(){
                                                $("#capa3").toggle();
                                            });

                                            $('[name="turno4"]').change(function(){
                                                $("#capa4").toggle();
                                            });

                                            $('[name="turno5"]').change(function(){
                                                $("#capa5").toggle();
                                            });

                                            $('[name="turno6"]').change(function(){
                                                $("#capa6").toggle();
                                            });*/
        ...
        <script>
            ...
            $('document').ready(function () {
                ...
                $('body').on('click','.cargar_modal_editar_inscripcion',function()
                {
                    ...
                    $.ajax({
                        type:       "POST",
                        url:        "?r=escuelaverano/MostrarModalEscuelaVeranoAlq",
                        data:       form_data,
                        dataType:   "json",
                        success:    function(data)
                        {
                            if(data.response==="success")
                            {
                              ...
                              //  $("#imgsip").val("<img src='https://servicios.alqueriadelbasket.com/".data.instancia['fotocopiasip']."' style='float:left; margin:15px;' width='100' height='100'/>");
                               ...
                               // imagen.src = 'imagen.php?img='+ data.instancia['fotocopiasip'];
                                ...
                                } else if (data.instancia['semana5']=="sem5_comp") {
                                    $("#turno5").prop('checked', true);
                              ...
                              /*  if (data.instancia['semana6']=="sem6_manyana") {
                                    $("#turno6").prop('checked', true); 
                                    $("input[name=rsem6][value='manyanas']").prop("checked",true);
                                } else if (data.instancia['semana6']=="sem6_comp") {
                                    $("#turno6").prop('checked', true);
                                    $("input[name=rsem6][value='completo']").prop("checked",true);
                                }
                                else {
                                    $("#turno6").prop('checked', false);
                                    $("input[name=rsem6][value='manyanas']").prop("checked",false);
                                    $("input[name=rsem6][value='completo']").prop("checked",false);
                                }
                                */
                ...
                $("#form_editar_inscripciones").validate(
                {
                    ...
                    {
    console.log("entra a recoger los datos");
                     ...
                     /*   var form_data = {
                        ...
                        $.ajax({
                                type: "POST",
                                url: "?r=escuelaverano/UpdateInscripcionModalEscuelaVeranoAlq",
                                data: formData,
