                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-12 alqueria-bg-box mt-3">
                                        ...
                                        <h4 class="t-center">
                                            No ha realizado el pago correctamente, vuelva a realizar la incripción.  
                                        </h4>

                                        <h4 class="t-center">
                                           Si persiste el error con el pago online póngase en contacto con recepción de L´Alqueria en el +34 961 215 543.
                                        </h4>

                                        <a class="btn btn-link-o" href="index.php" style="width:50%;">
