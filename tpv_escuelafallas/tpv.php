...
/*
$url="http://localhost/serviciosalqueria3/tpv_escuelafallas/ejemploRecepcionaPet.php";
$urlOK="http://localhost/serviciosalqueria3/tpv_escuelafallas/ejemploRecepcionaPet.php";
$urlKO="http://localhost/serviciosalqueria3/tpv_escuelafallas/ejemploRecepcionaPet.php";
*/

//entorno real

$url="https://servicios.alqueriadelbasket.com/tpv_escuelafallas/ejemploRecepcionaPet.php";  //entra por post
$urlOK="https://servicios.alqueriadelbasket.com/tpv_escuelafallas/ejemploRecepcionaPet.php";  //entra por get
$urlKO="https://servicios.alqueriadelbasket.com/tpv_escuelafallas/ejemploRecepcionaPet.php";
...
//valores fijos
$concepto = 'Escuela Fallas 2021';   //maximo 125 caracteres
