...
************************************************/
    ...
    class federacion_clubs
    {
        public static function findAll(){
            return db::singleton()->query('select * from federacion_clubs')->fetchAll();
        }

        public static function findLast(){
            return db::singleton()->query('select * from federacion_clubs order by ID desc limit 1')->fetch();
        }

        public static function getCount(){
            return db::singleton()->query('select *,count(*) from federacion_clubs group by ID')->fetch();
        }
        
    	public static function insert($Nombre)
        {        
            $sql='INSERT INTO federacion_clubs(Nombre)
		VALUES(:nombre)';
	...
	***********************/
	...
	{
		return db::singleton()->query('select * from federacion_clubs WHERE ID='.$ID)->fetch();
	}
	...
	***********************/
	...
	{
		$sql='delete from federacion_clubs';
	...
	public static function deleteByID($ID)
    	{
    		$sql="delete from federacion_clubs where ID=:id";
