                        ...
                        <div class="row mb-2">
                            <div class="col-12 t-center">
                                <h2 class="section-title mb-0">
                                    Encuesta <span class="orange-text">Aficionados</span>
                                </h2>
                            </div>
                            ...
                            <div class="col-12">
                                <p>A continuación, encontrará una serie de preguntas destinadas a conocer su opinión sobre diversos aspectos del L’Alqueria del Basket. Mediante ellas queremos conocer lo que piensan los aficionados del Valencia Basket sobre nosotros.</p>
                                <p>Tardará <u>menos de 5 minutos</u> en contestarla. Por favor, lea detenidamente cada pregunta  y conteste la alternativa que más se acerca a lo que piensa. Esta encuesta es <u>anónima</u>, pero si lo desea, puede dejarnos su nombre completo y correo electrónico para, una vez finalizada, entrar en el <u><strong>sorteo de 2 entradas para un partido del Valencia Basket</strong></u>. Muchas gracias.</p>
                            </div>
                        </div>

                        <!-- Encuesta -->
                        <div class="row">
                            <form id="encuesta-aficionados-form" class="boxed-form" method="post">
                                <div class="form-group col-12">
                                    <div class="row">

                                        <div class="col-12">
                                            <h4 class="mt-0 mb-1">
                                                Nombre (<strong>opcional</strong>):
                                            </h4>
                                        </div>
                                        ...
                                        <?php
                                        foreach ($datos["aficionados"] as $pregunta ) {
